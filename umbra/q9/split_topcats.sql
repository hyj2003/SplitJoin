...
JOIN (
 ...
 JOIN topcats AS t6 ON forceorder(t6.obj = intermediate_3.obj)) AS intermediate_15 JOIN 
...
(SELECT intermediate_20.intermediate_18_intermediate_5_sub AS intermediate_20_intermediate_18_intermediate_5_sub,
       ...
       intermediate_22.intermediate_21_intermediate_3_obj AS intermediate_22_intermediate_21_intermediate_3_obj,
...
JOIN (
    ...
    WHERE s.cnt > 323) c
    ON t.sub = c.val) AS intermediate_3
 JOIN topcats AS t6 ON forceorder(t6.obj = intermediate_3.obj)) AS intermediate_21 ON forceorder(intermediate_1.sub = intermediate_21.t6_sub AND intermediate_1.obj = intermediate_21.intermediate_3_sub)) AS intermediate_22 JOIN 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_10
 ON forceorder(intermediate_7.obj = intermediate_10.obj)) AS intermediate_19 JOIN 
(SELECT intermediate_5.sub AS intermediate_5_sub,
       intermediate_5.obj AS intermediate_5_obj,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_8
 ON forceorder(intermediate_5.sub = intermediate_8.sub)) AS intermediate_18 ON forceorder(intermediate_18.intermediate_5_obj = intermediate_19.intermediate_7_sub AND intermediate_18.intermediate_8_obj = intermediate_19.intermediate_10_sub)) AS intermediate_20 ON forceorder(intermediate_20.intermediate_19_intermediate_7_obj = intermediate_22.intermediate_1_sub AND intermediate_20.intermediate_19_intermediate_10_obj = intermediate_22.intermediate_21_t6_sub)) AS intermediate_23
;
SELECT COUNT(*)
FROM 
(SELECT intermediate_30.intermediate_28_intermediate_25_sub AS intermediate_30_intermediate_28_intermediate_25_sub,
       ...
       intermediate_32.intermediate_1_obj AS intermediate_32_intermediate_1_obj,
       intermediate_32.intermediate_31_intermediate_3_obj AS intermediate_32_intermediate_31_intermediate_3_obj,
       intermediate_32.intermediate_1_sub AS intermediate_32_intermediate_1_sub
FROM 
(SELECT intermediate_1.sub AS intermediate_1_sub,
       intermediate_1.obj AS intermediate_1_obj,
...
JOIN (
    ...
    WHERE s.cnt > 323) c
    ON t.sub = c.val) AS intermediate_3
 JOIN topcats AS t6 ON forceorder(t6.obj = intermediate_3.obj)) AS intermediate_31 ON forceorder(intermediate_1.sub = intermediate_31.t6_sub AND intermediate_1.obj = intermediate_31.intermediate_3_sub)) AS intermediate_32 JOIN 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_6
 ON forceorder(intermediate_6.obj = intermediate_27.obj)) AS intermediate_29 JOIN 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_4
 ON forceorder(intermediate_4.sub = intermediate_25.sub)) AS intermediate_28 ON forceorder(intermediate_28.intermediate_4_obj = intermediate_29.intermediate_6_sub AND intermediate_28.intermediate_25_obj = intermediate_29.intermediate_27_sub)) AS intermediate_30 ON forceorder(intermediate_30.intermediate_29_intermediate_6_obj = intermediate_32.intermediate_1_sub AND intermediate_30.intermediate_29_intermediate_27_obj = intermediate_32.intermediate_31_t6_sub)) AS intermediate_33
;
SELECT COUNT(*)
FROM 
(SELECT intermediate_34.intermediate_24_obj AS intermediate_34_intermediate_24_obj,
       ...
       intermediate_38.intermediate_37_intermediate_36_intermediate_3_sub AS intermediate_38_intermediate_37_intermediate_36_intermediate_3_sub,
       ...
       intermediate_38.intermediate_37_intermediate_36_intermediate_3_obj AS intermediate_38_intermediate_37_intermediate_36_intermediate_3_obj,
...
(SELECT intermediate_35.intermediate_6_obj AS intermediate_35_intermediate_6_obj,
       ...
       intermediate_37.intermediate_36_intermediate_3_sub AS intermediate_37_intermediate_36_intermediate_3_sub,
       intermediate_37.intermediate_36_t6_obj AS intermediate_37_intermediate_36_t6_obj,
       intermediate_37.intermediate_1_obj AS intermediate_37_intermediate_1_obj,
       intermediate_37.intermediate_36_intermediate_3_obj AS intermediate_37_intermediate_36_intermediate_3_obj,
       intermediate_37.intermediate_1_sub AS intermediate_37_intermediate_1_sub
FROM 
(SELECT intermediate_1.sub AS intermediate_1_sub,
       intermediate_1.obj AS intermediate_1_obj,
       intermediate_36.intermediate_3_sub AS intermediate_36_intermediate_3_sub,
       intermediate_36.t6_obj AS intermediate_36_t6_obj,
       intermediate_36.intermediate_3_obj AS intermediate_36_intermediate_3_obj,
...
JOIN (
    ...
    WHERE s.cnt > 323) c
    ON t.sub = c.val) AS intermediate_3
 JOIN topcats AS t6 ON forceorder(t6.obj = intermediate_3.obj)) AS intermediate_36 ON forceorder(intermediate_1.sub = intermediate_36.t6_sub AND intermediate_1.obj = intermediate_36.intermediate_3_sub)) AS intermediate_37 JOIN 
(SELECT intermediate_4.sub AS intermediate_4_sub,
       intermediate_4.obj AS intermediate_4_obj,
...
LEFT JOIN sub_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_4
 ON forceorder(intermediate_4.obj = intermediate_6.sub)) AS intermediate_35 ON forceorder(intermediate_35.intermediate_6_obj = intermediate_37.intermediate_1_sub)) AS intermediate_38 ON forceorder(intermediate_34.intermediate_24_sub = intermediate_38.intermediate_35_intermediate_4_sub AND intermediate_34.intermediate_26_obj = intermediate_38.intermediate_35_intermediate_6_obj AND intermediate_34.intermediate_26_obj = intermediate_38.intermediate_37_intermediate_36_t6_sub)) AS intermediate_39
;
SELECT COUNT(*)
FROM 
(SELECT intermediate_48.intermediate_41_obj AS intermediate_48_intermediate_41_obj,
       ...
       intermediate_52.intermediate_50_intermediate_49_intermediate_43_sub AS intermediate_52_intermediate_50_intermediate_49_intermediate_43_sub,
       intermediate_52.intermediate_50_t6_obj AS intermediate_52_intermediate_50_t6_obj,
       ...
       intermediate_52.intermediate_50_t6_sub AS intermediate_52_intermediate_50_t6_sub,
       intermediate_52.intermediate_50_intermediate_49_intermediate_47_sub AS intermediate_52_intermediate_50_intermediate_49_intermediate_47_sub,
       intermediate_52.intermediate_50_intermediate_49_intermediate_43_obj AS intermediate_52_intermediate_50_intermediate_49_intermediate_43_obj,
       intermediate_52.intermediate_51_intermediate_2_obj AS intermediate_52_intermediate_51_intermediate_2_obj,
       intermediate_52.intermediate_50_intermediate_49_intermediate_47_obj AS intermediate_52_intermediate_50_intermediate_49_intermediate_47_obj
FROM 
...
(SELECT intermediate_50.intermediate_49_intermediate_43_sub AS intermediate_50_intermediate_49_intermediate_43_sub,
       ...
       intermediate_50.t6_obj AS intermediate_50_t6_obj,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_0
 ON forceorder(intermediate_0.obj = intermediate_2.sub)) AS intermediate_51 JOIN 
...
JOIN (
 ...
 ON forceorder(intermediate_43.obj = intermediate_47.obj)) AS intermediate_49 ON forceorder(intermediate_49.intermediate_47_obj = t6.sub)) AS intermediate_50 ON forceorder(intermediate_50.intermediate_49_intermediate_43_obj = intermediate_51.intermediate_0_sub AND intermediate_50.t6_sub = intermediate_51.intermediate_0_sub AND intermediate_50.t6_obj = intermediate_51.intermediate_2_obj)) AS intermediate_52 ON forceorder(intermediate_48.intermediate_41_obj = intermediate_52.intermediate_50_intermediate_49_intermediate_43_sub AND intermediate_48.intermediate_45_obj = intermediate_52.intermediate_50_intermediate_49_intermediate_47_sub)) AS intermediate_53
;
SELECT COUNT(*)
FROM 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_46
 ON forceorder(intermediate_43.obj = intermediate_46.obj)) AS intermediate_55 JOIN 
(SELECT intermediate_41.sub AS intermediate_41_sub,
       intermediate_41.obj AS intermediate_41_obj,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_44
 ON forceorder(intermediate_41.sub = intermediate_44.sub)) AS intermediate_54 ON forceorder(intermediate_54.intermediate_41_obj = intermediate_55.intermediate_43_sub AND intermediate_54.intermediate_44_obj = intermediate_55.intermediate_46_sub)) AS intermediate_56 ON forceorder(intermediate_56.intermediate_55_intermediate_43_obj = intermediate_58.intermediate_57_intermediate_0_sub AND intermediate_56.intermediate_55_intermediate_46_obj = intermediate_58.t6_sub)) AS intermediate_59
;
SELECT COUNT(*)
FROM 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_42
 ON forceorder(intermediate_42.obj = intermediate_63.obj)) AS intermediate_65 JOIN 
...
FROM topcats t
LEFT JOIN sub_obj c ON t.sub = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_62
 JOIN 
(SELECT t.* 
FROM topcats t
LEFT JOIN sub_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_60
