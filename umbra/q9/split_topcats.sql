...
FROM 
    ...
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_6
     ON forceorder(intermediate_6.obj = intermediate_11.obj)) AS intermediate_19 JOIN 
(SELECT intermediate_4.sub AS intermediate_4_sub,
       intermediate_4.obj AS intermediate_4_obj,
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_26
     ON forceorder(intermediate_7.obj = intermediate_26.obj)) AS intermediate_29 JOIN 
...
(SELECT intermediate_34.intermediate_25_sub AS intermediate_34_intermediate_25_sub,
       ...
       intermediate_38.intermediate_36_t6_obj AS intermediate_38_intermediate_36_t6_obj,
       intermediate_38.intermediate_36_intermediate_35_intermediate_27_obj AS intermediate_38_intermediate_36_intermediate_35_intermediate_27_obj,
       intermediate_38.intermediate_36_t6_sub AS intermediate_38_intermediate_36_t6_sub,
       intermediate_38.intermediate_36_intermediate_35_intermediate_27_sub AS intermediate_38_intermediate_36_intermediate_35_intermediate_27_sub,
       intermediate_38.intermediate_37_intermediate_0_sub AS intermediate_38_intermediate_37_intermediate_0_sub,
       intermediate_38.intermediate_36_intermediate_35_intermediate_7_sub AS intermediate_38_intermediate_36_intermediate_35_intermediate_7_sub,
       intermediate_38.intermediate_36_intermediate_35_intermediate_7_obj AS intermediate_38_intermediate_36_intermediate_35_intermediate_7_obj
FROM 
(SELECT intermediate_5.sub AS intermediate_5_sub,
       intermediate_5.obj AS intermediate_5_obj,
...
(SELECT intermediate_36.t6_sub AS intermediate_36_t6_sub,
       intermediate_36.intermediate_35_intermediate_27_obj AS intermediate_36_intermediate_35_intermediate_27_obj,
...
FROM 
    ...
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_0
     ON forceorder(intermediate_0.obj = intermediate_2.sub)) AS intermediate_37 JOIN 
(SELECT intermediate_35.intermediate_27_sub AS intermediate_35_intermediate_27_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.sub = c.val) AS intermediate_7
     ON forceorder(intermediate_7.obj = intermediate_27.obj)) AS intermediate_35 ON forceorder(intermediate_35.intermediate_27_obj = t6.sub)) AS intermediate_36 ON forceorder(intermediate_36.intermediate_35_intermediate_7_obj = intermediate_37.intermediate_0_sub AND intermediate_36.t6_sub = intermediate_37.intermediate_0_sub AND intermediate_36.t6_obj = intermediate_37.intermediate_2_obj)) AS intermediate_38 ON forceorder(intermediate_34.intermediate_5_obj = intermediate_38.intermediate_36_intermediate_35_intermediate_7_sub AND intermediate_34.intermediate_25_obj = intermediate_38.intermediate_36_intermediate_35_intermediate_27_sub)) AS intermediate_39
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT intermediate_48.intermediate_44_sub AS intermediate_48_intermediate_44_sub,
       intermediate_48.intermediate_46_sub AS intermediate_48_intermediate_46_sub,
...
(SELECT intermediate_49.intermediate_42_obj AS intermediate_49_intermediate_42_obj,
       ...
       intermediate_49.intermediate_42_sub AS intermediate_49_intermediate_42_sub,
...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t6 ON forceorder(t6.obj = intermediate_3.obj)) AS intermediate_50 ON forceorder(intermediate_1.sub = intermediate_50.t6_sub AND intermediate_1.obj = intermediate_50.intermediate_3_sub)) AS intermediate_51 JOIN 
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_40
     ON forceorder(intermediate_40.obj = intermediate_42.sub)) AS intermediate_49 ON forceorder(intermediate_49.intermediate_42_obj = intermediate_51.intermediate_1_sub)) AS intermediate_52 ON forceorder(intermediate_48.intermediate_44_sub = intermediate_52.intermediate_49_intermediate_40_sub AND intermediate_48.intermediate_46_obj = intermediate_52.intermediate_49_intermediate_42_obj AND intermediate_48.intermediate_46_obj = intermediate_52.intermediate_51_intermediate_50_t6_sub)) AS intermediate_53
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
...
(SELECT intermediate_1.sub AS intermediate_1_sub,
       intermediate_1.obj AS intermediate_1_obj,
       intermediate_57.t6_obj AS intermediate_57_t6_obj,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.sub = c.val) AS intermediate_3
     JOIN topcats AS t6 ON forceorder(t6.obj = intermediate_3.obj)) AS intermediate_57 ON forceorder(intermediate_1.sub = intermediate_57.t6_sub AND intermediate_1.obj = intermediate_57.intermediate_3_sub)) AS intermediate_58 JOIN 
...
FROM 
    ...
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_42
     ON forceorder(intermediate_42.obj = intermediate_47.obj)) AS intermediate_55 JOIN 
(SELECT intermediate_40.sub AS intermediate_40_sub,
       intermediate_40.obj AS intermediate_40_obj,
...
FROM 
    ...
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_40
     ON forceorder(intermediate_40.sub = intermediate_45.sub)) AS intermediate_54 ON forceorder(intermediate_54.intermediate_40_obj = intermediate_55.intermediate_42_sub AND intermediate_54.intermediate_45_obj = intermediate_55.intermediate_47_sub)) AS intermediate_56 ON forceorder(intermediate_56.intermediate_55_intermediate_42_obj = intermediate_58.intermediate_1_sub AND intermediate_56.intermediate_55_intermediate_47_obj = intermediate_58.intermediate_57_t6_sub)) AS intermediate_59
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT intermediate_66.intermediate_64_intermediate_41_sub AS intermediate_66_intermediate_64_intermediate_41_sub,
       ...
       intermediate_68.intermediate_1_sub AS intermediate_68_intermediate_1_sub,
       intermediate_68.intermediate_67_intermediate_3_sub AS intermediate_68_intermediate_67_intermediate_3_sub,
       intermediate_68.intermediate_1_obj AS intermediate_68_intermediate_1_obj,
       ...
       intermediate_68.intermediate_67_intermediate_3_obj AS intermediate_68_intermediate_67_intermediate_3_obj
FROM 
(SELECT intermediate_1.sub AS intermediate_1_sub,
       intermediate_1.obj AS intermediate_1_obj,
       intermediate_67.t6_obj AS intermediate_67_t6_obj,
       intermediate_67.intermediate_3_obj AS intermediate_67_intermediate_3_obj,
       intermediate_67.intermediate_3_sub AS intermediate_67_intermediate_3_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.sub = c.val) AS intermediate_3
     JOIN topcats AS t6 ON forceorder(t6.obj = intermediate_3.obj)) AS intermediate_67 ON forceorder(intermediate_1.sub = intermediate_67.t6_sub AND intermediate_1.obj = intermediate_67.intermediate_3_sub)) AS intermediate_68 JOIN 
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_62
     ON forceorder(intermediate_43.obj = intermediate_62.obj)) AS intermediate_65 JOIN 
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_60
     ON forceorder(intermediate_41.sub = intermediate_60.sub)) AS intermediate_64 ON forceorder(intermediate_64.intermediate_41_obj = intermediate_65.intermediate_43_sub AND intermediate_64.intermediate_60_obj = intermediate_65.intermediate_62_sub)) AS intermediate_66 ON forceorder(intermediate_66.intermediate_65_intermediate_43_obj = intermediate_68.intermediate_1_sub AND intermediate_66.intermediate_65_intermediate_62_obj = intermediate_68.intermediate_67_t6_sub)) AS intermediate_69
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.sub = c.val) AS intermediate_3
     JOIN topcats AS t6 ON forceorder(t6.obj = intermediate_3.obj)) AS intermediate_73 JOIN 
