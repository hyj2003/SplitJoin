...
(SELECT intermediate_12.intermediate_9_obj AS intermediate_12_intermediate_9_obj,
       ...
       intermediate_16.intermediate_14_intermediate_13_intermediate_7_sub AS intermediate_16_intermediate_14_intermediate_13_intermediate_7_sub,
       intermediate_16.intermediate_15_t6_sub AS intermediate_16_intermediate_15_t6_sub,
       intermediate_16.intermediate_14_intermediate_13_intermediate_7_obj AS intermediate_16_intermediate_14_intermediate_13_intermediate_7_obj,
       intermediate_16.intermediate_15_intermediate_3_obj AS intermediate_16_intermediate_15_intermediate_3_obj,
       intermediate_16.intermediate_14_intermediate_11_sub AS intermediate_16_intermediate_14_intermediate_11_sub,
       intermediate_16.intermediate_15_t6_obj AS intermediate_16_intermediate_15_t6_obj,
       intermediate_16.intermediate_14_intermediate_11_obj AS intermediate_16_intermediate_14_intermediate_11_obj,
...
(SELECT intermediate_14.intermediate_13_intermediate_1_obj AS intermediate_14_intermediate_13_intermediate_1_obj,
       intermediate_14.intermediate_11_obj AS intermediate_14_intermediate_11_obj,
       intermediate_14.intermediate_13_intermediate_1_sub AS intermediate_14_intermediate_13_intermediate_1_sub,
       intermediate_14.intermediate_11_sub AS intermediate_14_intermediate_11_sub,
...
JOIN (
 ...
 JOIN gplus AS t6 ON forceorder(t6.obj = intermediate_3.obj)) AS intermediate_15 JOIN 
(SELECT intermediate_11.sub AS intermediate_11_sub,
...
JOIN (
 ...
 ON forceorder(intermediate_7.obj = intermediate_1.sub)) AS intermediate_13 ON forceorder(intermediate_11.obj = intermediate_13.intermediate_7_obj)) AS intermediate_14 ON forceorder(intermediate_14.intermediate_11_obj = intermediate_15.t6_sub AND intermediate_14.intermediate_13_intermediate_1_sub = intermediate_15.t6_sub AND intermediate_14.intermediate_13_intermediate_1_obj = intermediate_15.intermediate_3_sub)) AS intermediate_16 ON forceorder(intermediate_12.intermediate_5_obj = intermediate_16.intermediate_14_intermediate_13_intermediate_7_sub AND intermediate_12.intermediate_9_obj = intermediate_16.intermediate_14_intermediate_11_sub)) AS intermediate_17
;
SELECT COUNT(*)
FROM 
...
JOIN (
    ...
    WHERE s.cnt > 862) c
    ON t.obj = c.val) AS intermediate_1
 JOIN gplus AS t6 ON forceorder(intermediate_1.sub = t6.sub)) AS intermediate_21 ON forceorder(intermediate_21.intermediate_1_obj = intermediate_3.sub AND intermediate_21.t6_obj = intermediate_3.obj)) AS intermediate_22 JOIN 
...
JOIN (
    ...
    WHERE s.cnt > 862) c
    ON t.obj = c.val) AS intermediate_1
 JOIN gplus AS t6 ON forceorder(intermediate_1.sub = t6.sub)) AS intermediate_31 ON forceorder(intermediate_31.intermediate_1_obj = intermediate_3.sub AND intermediate_31.t6_obj = intermediate_3.obj)) AS intermediate_32 JOIN 
...
JOIN (
    ...
    WHERE s.cnt > 862) c
    ON t.obj = c.val) AS intermediate_1
 JOIN gplus AS t6 ON forceorder(intermediate_1.sub = t6.sub)) AS intermediate_37 ON forceorder(intermediate_37.intermediate_1_obj = intermediate_3.sub AND intermediate_37.t6_obj = intermediate_3.obj)) AS intermediate_38 JOIN 
