...
FROM 
    ...
    JOIN (
     ...
     JOIN orkut AS t6 ON forceorder(intermediate_1.sub = t6.sub)) AS intermediate_51 ON forceorder(intermediate_51.intermediate_1_obj = intermediate_3.sub AND intermediate_51.t6_obj = intermediate_3.obj)) AS intermediate_52 JOIN 
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 583) c
        ON t.obj = c.val) AS intermediate_1
     JOIN orkut AS t6 ON forceorder(intermediate_1.sub = t6.sub)) AS intermediate_57 ON forceorder(intermediate_57.intermediate_1_obj = intermediate_3.sub AND intermediate_57.t6_obj = intermediate_3.obj)) AS intermediate_58 JOIN 
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 583) c
        ON t.obj = c.val) AS intermediate_1
     JOIN orkut AS t6 ON forceorder(intermediate_1.sub = t6.sub)) AS intermediate_67 ON forceorder(intermediate_67.intermediate_1_obj = intermediate_3.sub AND intermediate_67.t6_obj = intermediate_3.obj)) AS intermediate_68 JOIN 
...
(SELECT intermediate_70.intermediate_41_sub AS intermediate_70_intermediate_41_sub,
       ...
       intermediate_74.intermediate_72_intermediate_3_obj AS intermediate_74_intermediate_72_intermediate_3_obj,
       intermediate_74.intermediate_73_intermediate_63_obj AS intermediate_74_intermediate_73_intermediate_63_obj,
       ...
       intermediate_74.intermediate_72_intermediate_71_t6_sub AS intermediate_74_intermediate_72_intermediate_71_t6_sub,
       ...
       intermediate_74.intermediate_73_intermediate_43_sub AS intermediate_74_intermediate_73_intermediate_43_sub,
       intermediate_74.intermediate_73_intermediate_43_obj AS intermediate_74_intermediate_73_intermediate_43_obj,
       intermediate_74.intermediate_72_intermediate_3_sub AS intermediate_74_intermediate_72_intermediate_3_sub,
       intermediate_74.intermediate_73_intermediate_63_sub AS intermediate_74_intermediate_73_intermediate_63_sub,
       intermediate_74.intermediate_72_intermediate_71_t6_obj AS intermediate_74_intermediate_72_intermediate_71_t6_obj
FROM 
(SELECT intermediate_41.sub AS intermediate_41_sub,
       intermediate_41.obj AS intermediate_41_obj,
...
(SELECT intermediate_72.intermediate_3_sub AS intermediate_72_intermediate_3_sub,
       intermediate_72.intermediate_71_t6_obj AS intermediate_72_intermediate_71_t6_obj,
       intermediate_72.intermediate_71_intermediate_1_sub AS intermediate_72_intermediate_71_intermediate_1_sub,
       intermediate_72.intermediate_3_obj AS intermediate_72_intermediate_3_obj,
       intermediate_72.intermediate_71_t6_sub AS intermediate_72_intermediate_71_t6_sub,
       intermediate_72.intermediate_71_intermediate_1_obj AS intermediate_72_intermediate_71_intermediate_1_obj,
       intermediate_73.intermediate_63_obj AS intermediate_73_intermediate_63_obj,
       intermediate_73.intermediate_43_sub AS intermediate_73_intermediate_43_sub,
       intermediate_73.intermediate_43_obj AS intermediate_73_intermediate_43_obj,
       intermediate_73.intermediate_63_sub AS intermediate_73_intermediate_63_sub
FROM 
(SELECT intermediate_71.t6_obj AS intermediate_71_t6_obj,
       intermediate_71.intermediate_1_obj AS intermediate_71_intermediate_1_obj,
       intermediate_71.t6_sub AS intermediate_71_t6_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 583) c
        ON t.obj = c.val) AS intermediate_1
     JOIN orkut AS t6 ON forceorder(intermediate_1.sub = t6.sub)) AS intermediate_71 ON forceorder(intermediate_71.intermediate_1_obj = intermediate_3.sub AND intermediate_71.t6_obj = intermediate_3.obj)) AS intermediate_72 JOIN 
(SELECT intermediate_43.sub AS intermediate_43_sub,
       intermediate_43.obj AS intermediate_43_obj,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 583) c
        ON t.sub = c.val) AS intermediate_43
     ON forceorder(intermediate_43.obj = intermediate_63.obj)) AS intermediate_73 ON forceorder(intermediate_72.intermediate_71_intermediate_1_sub = intermediate_73.intermediate_43_obj AND intermediate_72.intermediate_71_t6_sub = intermediate_73.intermediate_63_obj)) AS intermediate_74 ON forceorder(intermediate_70.intermediate_41_obj = intermediate_74.intermediate_73_intermediate_43_sub AND intermediate_70.intermediate_61_obj = intermediate_74.intermediate_73_intermediate_63_sub)) AS intermediate_75
        ;