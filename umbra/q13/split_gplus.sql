...
FROM 
    ...
    JOIN (
     ...
     JOIN gplus AS t3 ON forceorder(t3.obj = intermediate_5.obj)) AS intermediate_12 JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN gplus AS t3 ON forceorder(intermediate_3.obj = t3.sub)) AS intermediate_20 JOIN 
...
(SELECT intermediate_24.intermediate_1_obj AS intermediate_24_intermediate_1_obj,
       ...
       intermediate_26.intermediate_25_t3_obj AS intermediate_26_intermediate_25_t3_obj,
       ...
       intermediate_26.intermediate_25_t3_sub AS intermediate_26_intermediate_25_t3_sub
FROM 
(SELECT intermediate_1.obj AS intermediate_1_obj,
       intermediate_1.sub AS intermediate_1_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 862) c
        ON t.obj = c.val) AS intermediate_1
     ON forceorder(intermediate_1.sub = intermediate_19.sub)) AS intermediate_24 JOIN 
(SELECT intermediate_25.intermediate_3_obj AS intermediate_25_intermediate_3_obj,
       intermediate_25.t3_obj AS intermediate_25_t3_obj,
       intermediate_25.intermediate_3_sub AS intermediate_25_intermediate_3_sub,
       intermediate_25.t3_sub AS intermediate_25_t3_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 862) c
        ON t.sub = c.val) AS intermediate_3
     JOIN gplus AS t3 ON forceorder(intermediate_3.obj = t3.sub)) AS intermediate_25 ON forceorder(intermediate_25.t3_obj = intermediate_17.obj)) AS intermediate_26 ON forceorder(intermediate_24.intermediate_1_obj = intermediate_26.intermediate_25_intermediate_3_sub AND intermediate_24.intermediate_19_obj = intermediate_26.intermediate_17_sub)) AS intermediate_27
        ;