...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t3 ON forceorder(t3.obj = intermediate_5.obj)) AS intermediate_12 JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t3 ON forceorder(intermediate_3.obj = t3.sub)) AS intermediate_20 JOIN 
