...
SELECT COUNT(*)
FROM 
(SELECT intermediate_9.intermediate_8_intermediate_0_obj AS intermediate_9_intermediate_8_intermediate_0_obj,
...
(SELECT intermediate_8.intermediate_0_sub AS intermediate_8_intermediate_0_sub,
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_12.intermediate_5_sub AS intermediate_12_intermediate_5_sub,
...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t3 ON forceorder(t3.obj = intermediate_5.obj)) AS intermediate_12 JOIN 
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_20.t3_sub AS intermediate_20_t3_sub,
...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t3 ON forceorder(intermediate_3.obj = t3.sub)) AS intermediate_20 JOIN 
...
(SELECT intermediate_24.t3_sub AS intermediate_24_t3_sub,
