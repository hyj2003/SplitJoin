...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_10
     JOIN 
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_8
     JOIN 
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_23.intermediate_22_intermediate_21_intermediate_6_obj AS intermediate_23_intermediate_22_intermediate_21_intermediate_6_obj,
       intermediate_23.intermediate_20_intermediate_19_intermediate_0_sub AS intermediate_23_intermediate_20_intermediate_19_intermediate_0_sub,
       intermediate_23.intermediate_20_intermediate_19_intermediate_2_sub AS intermediate_23_intermediate_20_intermediate_19_intermediate_2_sub,
       intermediate_23.intermediate_20_t3_sub AS intermediate_23_intermediate_20_t3_sub,
       intermediate_23.intermediate_20_intermediate_19_intermediate_0_obj AS intermediate_23_intermediate_20_intermediate_19_intermediate_0_obj,
       intermediate_23.intermediate_22_intermediate_21_intermediate_9_sub AS intermediate_23_intermediate_22_intermediate_21_intermediate_9_sub,
       intermediate_23.intermediate_22_intermediate_21_intermediate_6_sub AS intermediate_23_intermediate_22_intermediate_21_intermediate_6_sub,
       intermediate_23.intermediate_22_intermediate_21_intermediate_9_obj AS intermediate_23_intermediate_22_intermediate_21_intermediate_9_obj,
       intermediate_23.intermediate_22_intermediate_4_sub AS intermediate_23_intermediate_22_intermediate_4_sub,
       intermediate_23.intermediate_20_intermediate_19_intermediate_2_obj AS intermediate_23_intermediate_20_intermediate_19_intermediate_2_obj,
       intermediate_23.intermediate_22_intermediate_4_obj AS intermediate_23_intermediate_22_intermediate_4_obj,
       intermediate_23.intermediate_20_t3_obj AS intermediate_23_intermediate_20_t3_obj,
       intermediate_24.t8_obj AS intermediate_24_t8_obj,
       ...
       intermediate_24.t8_sub AS intermediate_24_t8_sub
FROM 
...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t8 ON forceorder(t8.sub = intermediate_11.sub)) AS intermediate_24 JOIN 
(SELECT intermediate_20.intermediate_19_intermediate_2_sub AS intermediate_20_intermediate_19_intermediate_2_sub,
       ...
       intermediate_22.intermediate_21_intermediate_6_sub AS intermediate_22_intermediate_21_intermediate_6_sub,
       intermediate_22.intermediate_21_intermediate_9_sub AS intermediate_22_intermediate_21_intermediate_9_sub,
       intermediate_22.intermediate_21_intermediate_9_obj AS intermediate_22_intermediate_21_intermediate_9_obj,
       intermediate_22.intermediate_21_intermediate_6_obj AS intermediate_22_intermediate_21_intermediate_6_obj,
       intermediate_22.intermediate_4_sub AS intermediate_22_intermediate_4_sub,
       intermediate_22.intermediate_4_obj AS intermediate_22_intermediate_4_obj
FROM 
(SELECT intermediate_4.sub AS intermediate_4_sub,
       intermediate_4.obj AS intermediate_4_obj,
       intermediate_21.intermediate_9_sub AS intermediate_21_intermediate_9_sub,
       intermediate_21.intermediate_6_sub AS intermediate_21_intermediate_6_sub,
       intermediate_21.intermediate_9_obj AS intermediate_21_intermediate_9_obj,
       intermediate_21.intermediate_6_obj AS intermediate_21_intermediate_6_obj
FROM 
    (SELECT t.* 
    FROM topcats t
    LEFT JOIN sub_obj c ON t.sub = c.val
...
FROM 
    ...
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_6
     ON forceorder(intermediate_9.obj = intermediate_6.sub)) AS intermediate_21 ON forceorder(intermediate_4.obj = intermediate_21.intermediate_9_sub AND intermediate_4.sub = intermediate_21.intermediate_6_obj)) AS intermediate_22 JOIN 
...
FROM 
    ...
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_0
     ON forceorder(intermediate_0.obj = intermediate_2.sub)) AS intermediate_19 ON forceorder(intermediate_19.intermediate_0_sub = t3.obj AND intermediate_19.intermediate_2_obj = t3.sub)) AS intermediate_20 ON forceorder(intermediate_20.intermediate_19_intermediate_2_obj = intermediate_22.intermediate_21_intermediate_9_obj)) AS intermediate_23 ON forceorder(intermediate_23.intermediate_20_intermediate_19_intermediate_2_sub = intermediate_24.t8_obj AND intermediate_23.intermediate_22_intermediate_21_intermediate_9_sub = intermediate_24.intermediate_11_obj)) AS intermediate_25
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_28
     JOIN 
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_26
...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t8 ON forceorder(t8.sub = intermediate_29.sub)) AS intermediate_42 JOIN 
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_50
     JOIN 
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_48
     JOIN 
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_46
     JOIN 
    (SELECT t.* 
    FROM topcats t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_44
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_63.intermediate_60_intermediate_1_obj AS intermediate_63_intermediate_60_intermediate_1_obj,
       intermediate_63.intermediate_60_intermediate_59_t3_sub AS intermediate_63_intermediate_60_intermediate_59_t3_sub,
       intermediate_63.intermediate_62_intermediate_44_sub AS intermediate_63_intermediate_62_intermediate_44_sub,
       intermediate_63.intermediate_62_intermediate_61_intermediate_49_obj AS intermediate_63_intermediate_62_intermediate_61_intermediate_49_obj,
       intermediate_63.intermediate_62_intermediate_61_intermediate_46_obj AS intermediate_63_intermediate_62_intermediate_61_intermediate_46_obj,
       intermediate_63.intermediate_60_intermediate_59_intermediate_3_sub AS intermediate_63_intermediate_60_intermediate_59_intermediate_3_sub,
       intermediate_63.intermediate_62_intermediate_61_intermediate_46_sub AS intermediate_63_intermediate_62_intermediate_61_intermediate_46_sub,
       intermediate_63.intermediate_60_intermediate_59_intermediate_3_obj AS intermediate_63_intermediate_60_intermediate_59_intermediate_3_obj,
       intermediate_63.intermediate_62_intermediate_44_obj AS intermediate_63_intermediate_62_intermediate_44_obj,
       intermediate_63.intermediate_60_intermediate_1_sub AS intermediate_63_intermediate_60_intermediate_1_sub,
       intermediate_63.intermediate_60_intermediate_59_t3_obj AS intermediate_63_intermediate_60_intermediate_59_t3_obj,
       intermediate_63.intermediate_62_intermediate_61_intermediate_49_sub AS intermediate_63_intermediate_62_intermediate_61_intermediate_49_sub,
       intermediate_64.t8_obj AS intermediate_64_t8_obj,
       intermediate_64.intermediate_51_obj AS intermediate_64_intermediate_51_obj,
       intermediate_64.t8_sub AS intermediate_64_t8_sub,
       intermediate_64.intermediate_51_sub AS intermediate_64_intermediate_51_sub
FROM 
(SELECT t8.sub AS t8_sub,
       t8.obj AS t8_obj,
...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t8 ON forceorder(t8.sub = intermediate_51.sub)) AS intermediate_64 JOIN 
(SELECT intermediate_60.intermediate_59_intermediate_3_sub AS intermediate_60_intermediate_59_intermediate_3_sub,
       intermediate_60.intermediate_59_t3_obj AS intermediate_60_intermediate_59_t3_obj,
       intermediate_60.intermediate_1_sub AS intermediate_60_intermediate_1_sub,
       intermediate_60.intermediate_1_obj AS intermediate_60_intermediate_1_obj,
       intermediate_60.intermediate_59_intermediate_3_obj AS intermediate_60_intermediate_59_intermediate_3_obj,
       intermediate_60.intermediate_59_t3_sub AS intermediate_60_intermediate_59_t3_sub,
       intermediate_62.intermediate_61_intermediate_46_obj AS intermediate_62_intermediate_61_intermediate_46_obj,
       intermediate_62.intermediate_61_intermediate_46_sub AS intermediate_62_intermediate_61_intermediate_46_sub,
       intermediate_62.intermediate_61_intermediate_49_obj AS intermediate_62_intermediate_61_intermediate_49_obj,
       intermediate_62.intermediate_44_obj AS intermediate_62_intermediate_44_obj,
       intermediate_62.intermediate_44_sub AS intermediate_62_intermediate_44_sub,
       intermediate_62.intermediate_61_intermediate_49_sub AS intermediate_62_intermediate_61_intermediate_49_sub
FROM 
(SELECT intermediate_44.sub AS intermediate_44_sub,
       intermediate_44.obj AS intermediate_44_obj,
       intermediate_61.intermediate_46_obj AS intermediate_61_intermediate_46_obj,
       intermediate_61.intermediate_49_sub AS intermediate_61_intermediate_49_sub,
       intermediate_61.intermediate_46_sub AS intermediate_61_intermediate_46_sub,
       intermediate_61.intermediate_49_obj AS intermediate_61_intermediate_49_obj
FROM 
    (SELECT t.* 
    FROM topcats t
    LEFT JOIN sub_obj c ON t.sub = c.val
...
FROM 
    ...
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_46
     ON forceorder(intermediate_49.obj = intermediate_46.sub)) AS intermediate_61 ON forceorder(intermediate_44.obj = intermediate_61.intermediate_49_sub AND intermediate_44.sub = intermediate_61.intermediate_46_obj)) AS intermediate_62 JOIN 
(SELECT intermediate_1.sub AS intermediate_1_sub,
       intermediate_1.obj AS intermediate_1_obj,
       intermediate_59.intermediate_3_sub AS intermediate_59_intermediate_3_sub,
       intermediate_59.t3_sub AS intermediate_59_t3_sub,
       intermediate_59.t3_obj AS intermediate_59_t3_obj,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.sub = c.val) AS intermediate_3
     JOIN topcats AS t3 ON forceorder(intermediate_3.obj = t3.sub)) AS intermediate_59 ON forceorder(intermediate_1.obj = intermediate_59.intermediate_3_sub AND intermediate_1.sub = intermediate_59.t3_obj)) AS intermediate_60 ON forceorder(intermediate_60.intermediate_59_intermediate_3_obj = intermediate_62.intermediate_61_intermediate_49_obj)) AS intermediate_63 ON forceorder(intermediate_63.intermediate_60_intermediate_59_intermediate_3_sub = intermediate_64.t8_obj AND intermediate_63.intermediate_62_intermediate_61_intermediate_49_sub = intermediate_64.intermediate_51_obj)) AS intermediate_65
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT intermediate_70.t3_sub AS intermediate_70_t3_sub,
       intermediate_70.intermediate_1_sub AS intermediate_70_intermediate_1_sub,
       intermediate_70.intermediate_1_obj AS intermediate_70_intermediate_1_obj,
       intermediate_70.t3_obj AS intermediate_70_t3_obj,
       intermediate_75.intermediate_74_intermediate_68_sub AS intermediate_75_intermediate_74_intermediate_68_sub,
       intermediate_75.intermediate_71_intermediate_3_sub AS intermediate_75_intermediate_71_intermediate_3_sub,
       intermediate_75.intermediate_74_intermediate_73_intermediate_72_intermediate_66_sub AS intermediate_75_intermediate_74_intermediate_73_intermediate_72_intermediate_66_sub,
       intermediate_75.intermediate_74_intermediate_73_intermediate_72_intermediate_47_sub AS intermediate_75_intermediate_74_intermediate_73_intermediate_72_intermediate_47_sub,
       intermediate_75.intermediate_71_t8_obj AS intermediate_75_intermediate_71_t8_obj,
       intermediate_75.intermediate_74_intermediate_68_obj AS intermediate_75_intermediate_74_intermediate_68_obj,
       intermediate_75.intermediate_71_intermediate_3_obj AS intermediate_75_intermediate_71_intermediate_3_obj,
       intermediate_75.intermediate_74_intermediate_73_intermediate_45_sub AS intermediate_75_intermediate_74_intermediate_73_intermediate_45_sub,
       intermediate_75.intermediate_71_t8_sub AS intermediate_75_intermediate_71_t8_sub,
       intermediate_75.intermediate_74_intermediate_73_intermediate_72_intermediate_47_obj AS intermediate_75_intermediate_74_intermediate_73_intermediate_72_intermediate_47_obj,
       intermediate_75.intermediate_74_intermediate_73_intermediate_72_intermediate_66_obj AS intermediate_75_intermediate_74_intermediate_73_intermediate_72_intermediate_66_obj,
       intermediate_75.intermediate_74_intermediate_73_intermediate_45_obj AS intermediate_75_intermediate_74_intermediate_73_intermediate_45_obj
FROM 
(SELECT intermediate_1.sub AS intermediate_1_sub,
       intermediate_1.obj AS intermediate_1_obj,
       t3.sub AS t3_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.obj = c.val) AS intermediate_1
     JOIN topcats AS t3 ON forceorder(intermediate_1.sub = t3.obj)) AS intermediate_70 JOIN 
(SELECT intermediate_71.intermediate_3_sub AS intermediate_71_intermediate_3_sub,
       intermediate_71.t8_sub AS intermediate_71_t8_sub,
       intermediate_71.t8_obj AS intermediate_71_t8_obj,
       intermediate_71.intermediate_3_obj AS intermediate_71_intermediate_3_obj,
       intermediate_74.intermediate_68_sub AS intermediate_74_intermediate_68_sub,
       intermediate_74.intermediate_73_intermediate_45_obj AS intermediate_74_intermediate_73_intermediate_45_obj,
       intermediate_74.intermediate_73_intermediate_72_intermediate_66_obj AS intermediate_74_intermediate_73_intermediate_72_intermediate_66_obj,
       intermediate_74.intermediate_68_obj AS intermediate_74_intermediate_68_obj,
       intermediate_74.intermediate_73_intermediate_45_sub AS intermediate_74_intermediate_73_intermediate_45_sub,
       intermediate_74.intermediate_73_intermediate_72_intermediate_66_sub AS intermediate_74_intermediate_73_intermediate_72_intermediate_66_sub,
       intermediate_74.intermediate_73_intermediate_72_intermediate_47_sub AS intermediate_74_intermediate_73_intermediate_72_intermediate_47_sub,
       intermediate_74.intermediate_73_intermediate_72_intermediate_47_obj AS intermediate_74_intermediate_73_intermediate_72_intermediate_47_obj
FROM 
(SELECT intermediate_3.sub AS intermediate_3_sub,
       intermediate_3.obj AS intermediate_3_obj,
       t8.sub AS t8_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.sub = c.val) AS intermediate_3
     JOIN topcats AS t8 ON forceorder(intermediate_3.sub = t8.obj)) AS intermediate_71 JOIN 
(SELECT intermediate_73.intermediate_72_intermediate_66_sub AS intermediate_73_intermediate_72_intermediate_66_sub,
       intermediate_73.intermediate_72_intermediate_47_obj AS intermediate_73_intermediate_72_intermediate_47_obj,
       intermediate_73.intermediate_72_intermediate_47_sub AS intermediate_73_intermediate_72_intermediate_47_sub,
       intermediate_73.intermediate_45_sub AS intermediate_73_intermediate_45_sub,
       intermediate_73.intermediate_72_intermediate_66_obj AS intermediate_73_intermediate_72_intermediate_66_obj,
       intermediate_73.intermediate_45_obj AS intermediate_73_intermediate_45_obj,
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_68
     JOIN 
(SELECT intermediate_45.sub AS intermediate_45_sub,
       intermediate_45.obj AS intermediate_45_obj,
       intermediate_72.intermediate_47_obj AS intermediate_72_intermediate_47_obj,
       intermediate_72.intermediate_47_sub AS intermediate_72_intermediate_47_sub,
       intermediate_72.intermediate_66_sub AS intermediate_72_intermediate_66_sub,
       intermediate_72.intermediate_66_obj AS intermediate_72_intermediate_66_obj
FROM 
    (SELECT t.* 
    FROM topcats t
    JOIN (
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_66
     ON forceorder(intermediate_66.obj = intermediate_47.sub)) AS intermediate_72 ON forceorder(intermediate_45.obj = intermediate_72.intermediate_66_sub AND intermediate_45.sub = intermediate_72.intermediate_47_obj)) AS intermediate_73 ON forceorder(intermediate_73.intermediate_72_intermediate_66_sub = intermediate_68.obj)) AS intermediate_74 ON forceorder(intermediate_71.t8_sub = intermediate_74.intermediate_68_sub AND intermediate_71.intermediate_3_obj = intermediate_74.intermediate_73_intermediate_72_intermediate_66_obj)) AS intermediate_75 ON forceorder(intermediate_70.intermediate_1_obj = intermediate_75.intermediate_71_intermediate_3_sub AND intermediate_70.t3_sub = intermediate_75.intermediate_71_intermediate_3_obj)) AS intermediate_76
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT intermediate_81.intermediate_77_intermediate_1_obj AS intermediate_81_intermediate_77_intermediate_1_obj,
       intermediate_81.intermediate_80_intermediate_79_intermediate_45_obj AS intermediate_81_intermediate_80_intermediate_79_intermediate_45_obj,
       intermediate_81.intermediate_80_intermediate_79_intermediate_45_sub AS intermediate_81_intermediate_80_intermediate_79_intermediate_45_sub,
       intermediate_81.intermediate_77_intermediate_1_sub AS intermediate_81_intermediate_77_intermediate_1_sub,
       intermediate_81.intermediate_80_intermediate_3_sub AS intermediate_81_intermediate_80_intermediate_3_sub,
       intermediate_81.intermediate_80_intermediate_3_obj AS intermediate_81_intermediate_80_intermediate_3_obj,
       intermediate_81.intermediate_80_intermediate_79_intermediate_78_intermediate_47_obj AS intermediate_81_intermediate_80_intermediate_79_intermediate_78_intermediate_47_obj,
       intermediate_81.intermediate_77_t3_sub AS intermediate_81_intermediate_77_t3_sub,
       intermediate_81.intermediate_80_intermediate_79_intermediate_78_intermediate_67_obj AS intermediate_81_intermediate_80_intermediate_79_intermediate_78_intermediate_67_obj,
       intermediate_81.intermediate_80_intermediate_79_intermediate_78_intermediate_67_sub AS intermediate_81_intermediate_80_intermediate_79_intermediate_78_intermediate_67_sub,
       intermediate_81.intermediate_77_t3_obj AS intermediate_81_intermediate_77_t3_obj,
       intermediate_81.intermediate_80_intermediate_79_intermediate_78_intermediate_47_sub AS intermediate_81_intermediate_80_intermediate_79_intermediate_78_intermediate_47_sub,
...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t8 ON forceorder(t8.sub = intermediate_69.sub)) AS intermediate_82 JOIN 
(SELECT intermediate_77.t3_sub AS intermediate_77_t3_sub,
       intermediate_77.intermediate_1_sub AS intermediate_77_intermediate_1_sub,
       intermediate_77.intermediate_1_obj AS intermediate_77_intermediate_1_obj,
       intermediate_77.t3_obj AS intermediate_77_t3_obj,
       intermediate_80.intermediate_79_intermediate_78_intermediate_67_obj AS intermediate_80_intermediate_79_intermediate_78_intermediate_67_obj,
       intermediate_80.intermediate_3_sub AS intermediate_80_intermediate_3_sub,
       intermediate_80.intermediate_79_intermediate_78_intermediate_67_sub AS intermediate_80_intermediate_79_intermediate_78_intermediate_67_sub,
       intermediate_80.intermediate_79_intermediate_78_intermediate_47_sub AS intermediate_80_intermediate_79_intermediate_78_intermediate_47_sub,
       intermediate_80.intermediate_79_intermediate_78_intermediate_47_obj AS intermediate_80_intermediate_79_intermediate_78_intermediate_47_obj,
       intermediate_80.intermediate_79_intermediate_45_sub AS intermediate_80_intermediate_79_intermediate_45_sub,
       intermediate_80.intermediate_79_intermediate_45_obj AS intermediate_80_intermediate_79_intermediate_45_obj,
       intermediate_80.intermediate_3_obj AS intermediate_80_intermediate_3_obj
FROM 
(SELECT intermediate_1.sub AS intermediate_1_sub,
       intermediate_1.obj AS intermediate_1_obj,
       t3.sub AS t3_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.obj = c.val) AS intermediate_1
     JOIN topcats AS t3 ON forceorder(intermediate_1.sub = t3.obj)) AS intermediate_77 JOIN 
(SELECT intermediate_3.sub AS intermediate_3_sub,
       intermediate_3.obj AS intermediate_3_obj,
       intermediate_79.intermediate_78_intermediate_47_obj AS intermediate_79_intermediate_78_intermediate_47_obj,
       intermediate_79.intermediate_78_intermediate_67_sub AS intermediate_79_intermediate_78_intermediate_67_sub,
       intermediate_79.intermediate_45_obj AS intermediate_79_intermediate_45_obj,
       intermediate_79.intermediate_45_sub AS intermediate_79_intermediate_45_sub,
       intermediate_79.intermediate_78_intermediate_67_obj AS intermediate_79_intermediate_78_intermediate_67_obj,
       intermediate_79.intermediate_78_intermediate_47_sub AS intermediate_79_intermediate_78_intermediate_47_sub
FROM 
    (SELECT t.* 
    FROM topcats t
    JOIN (
...
(SELECT intermediate_45.sub AS intermediate_45_sub,
       intermediate_45.obj AS intermediate_45_obj,
       intermediate_78.intermediate_67_sub AS intermediate_78_intermediate_67_sub,
       intermediate_78.intermediate_47_sub AS intermediate_78_intermediate_47_sub,
       intermediate_78.intermediate_67_obj AS intermediate_78_intermediate_67_obj,
       intermediate_78.intermediate_47_obj AS intermediate_78_intermediate_47_obj
FROM 
    (SELECT t.* 
    FROM topcats t
    JOIN (
...
FROM 
    ...
    JOIN (
     ...
     ON forceorder(intermediate_67.obj = intermediate_47.sub)) AS intermediate_78 ON forceorder(intermediate_45.obj = intermediate_78.intermediate_67_sub AND intermediate_45.sub = intermediate_78.intermediate_47_obj)) AS intermediate_79 ON forceorder(intermediate_3.obj = intermediate_79.intermediate_78_intermediate_67_obj)) AS intermediate_80 ON forceorder(intermediate_77.intermediate_1_obj = intermediate_80.intermediate_3_sub AND intermediate_77.t3_sub = intermediate_80.intermediate_3_obj)) AS intermediate_81 ON forceorder(intermediate_81.intermediate_80_intermediate_3_sub = intermediate_82.t8_obj AND intermediate_81.intermediate_80_intermediate_79_intermediate_78_intermediate_67_sub = intermediate_82.intermediate_69_obj)) AS intermediate_83
        ;