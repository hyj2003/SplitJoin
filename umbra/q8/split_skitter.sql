...
\echo join time:
EXPLAIN ANALYZE EXPLAIN ANALYZE SELECT COUNT(*) FROM skitter AS t1, skitter AS t2, skitter AS t3, skitter AS t4, skitter AS t5, skitter AS t6, skitter AS t7, skitter AS t8
