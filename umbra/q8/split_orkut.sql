...
CREATE TABLE group_obj AS (SELECT obj AS val, COUNT(*) AS cnt FROM orkut GROUP BY obj ORDER BY cnt DESC LIMIT 100000);
CREATE TABLE group_sub AS (SELECT sub AS val, COUNT(*) AS cnt FROM orkut GROUP BY sub ORDER BY cnt DESC LIMIT 100000);
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_16.intermediate_13_intermediate_5_sub AS intermediate_16_intermediate_13_intermediate_5_sub,
       intermediate_16.intermediate_13_intermediate_12_intermediate_7_obj AS intermediate_16_intermediate_13_intermediate_12_intermediate_7_obj,
       intermediate_16.intermediate_15_intermediate_1_sub AS intermediate_16_intermediate_15_intermediate_1_sub,
       intermediate_16.intermediate_13_intermediate_5_obj AS intermediate_16_intermediate_13_intermediate_5_obj,
       ...
       intermediate_16.intermediate_13_intermediate_12_intermediate_7_sub AS intermediate_16_intermediate_13_intermediate_12_intermediate_7_sub,
       intermediate_16.intermediate_15_intermediate_14_t3_obj AS intermediate_16_intermediate_15_intermediate_14_t3_obj,
       ...
       intermediate_16.intermediate_15_intermediate_14_t3_sub AS intermediate_16_intermediate_15_intermediate_14_t3_sub,
       intermediate_16.intermediate_13_intermediate_12_intermediate_9_obj AS intermediate_16_intermediate_13_intermediate_12_intermediate_9_obj,
       intermediate_16.intermediate_13_intermediate_12_intermediate_9_sub AS intermediate_16_intermediate_13_intermediate_12_intermediate_9_sub,
...
JOIN (
 ...
 JOIN orkut AS t8 ON forceorder(t8.sub = intermediate_11.sub)) AS intermediate_17 JOIN 
(SELECT intermediate_13.intermediate_12_intermediate_9_obj AS intermediate_13_intermediate_12_intermediate_9_obj,
       ...
       intermediate_13.intermediate_12_intermediate_9_sub AS intermediate_13_intermediate_12_intermediate_9_sub,
       ...
       intermediate_15.intermediate_14_t3_obj AS intermediate_15_intermediate_14_t3_obj,
       intermediate_15.intermediate_14_t3_sub AS intermediate_15_intermediate_14_t3_sub,
...
(SELECT intermediate_5.obj AS intermediate_5_obj,
       ...
       intermediate_12.intermediate_9_obj AS intermediate_12_intermediate_9_obj
FROM 
(SELECT t.* 
FROM orkut t
JOIN (
...
JOIN (
 ...
 ON forceorder(intermediate_9.obj = intermediate_7.sub)) AS intermediate_12 ON forceorder(intermediate_5.obj = intermediate_12.intermediate_9_sub AND intermediate_5.sub = intermediate_12.intermediate_7_obj)) AS intermediate_13 JOIN 
(SELECT intermediate_1.obj AS intermediate_1_obj,
       ...
       intermediate_14.t3_obj AS intermediate_14_t3_obj,
       intermediate_14.t3_sub AS intermediate_14_t3_sub
FROM 
(SELECT t.* 
FROM orkut t
JOIN (
...
JOIN (
 ...
 JOIN orkut AS t3 ON forceorder(intermediate_3.obj = t3.sub)) AS intermediate_14 ON forceorder(intermediate_1.obj = intermediate_14.intermediate_3_sub AND intermediate_1.sub = intermediate_14.t3_obj)) AS intermediate_15 ON forceorder(intermediate_13.intermediate_12_intermediate_9_obj = intermediate_15.intermediate_14_intermediate_3_obj)) AS intermediate_16 ON forceorder(intermediate_16.intermediate_15_intermediate_14_intermediate_3_sub = intermediate_17.t8_obj AND intermediate_16.intermediate_13_intermediate_12_intermediate_9_sub = intermediate_17.intermediate_11_obj)) AS intermediate_18
;
SELECT COUNT(*)
FROM 
...
JOIN (
    ...
    WHERE s.cnt > 583) c
    ON t.obj = c.val) AS intermediate_1
 JOIN orkut AS t3 ON forceorder(intermediate_1.sub = t3.obj)) AS intermediate_19 JOIN 
...
JOIN (
    ...
    WHERE s.cnt > 583) c
    ON t.sub = c.val) AS intermediate_3
 JOIN orkut AS t8 ON forceorder(intermediate_3.sub = t8.obj)) AS intermediate_20 JOIN 
...
JOIN (
 ...
 JOIN orkut AS t8 ON forceorder(t8.sub = intermediate_29.sub)) AS intermediate_35 JOIN 
...
JOIN (
 ...
 JOIN orkut AS t8 ON forceorder(t8.sub = intermediate_51.sub)) AS intermediate_57 JOIN 
...
JOIN (
 ...
 JOIN orkut AS t8 ON forceorder(t8.sub = intermediate_69.sub)) AS intermediate_75 JOIN 
