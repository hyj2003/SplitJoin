...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_10
     JOIN 
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_8
     JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN orkut AS t8 ON forceorder(t8.sub = intermediate_11.sub)) AS intermediate_24 JOIN 
...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_28
     JOIN 
...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_26
...
FROM 
    ...
    JOIN (
     ...
     JOIN orkut AS t8 ON forceorder(t8.sub = intermediate_29.sub)) AS intermediate_42 JOIN 
...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_50
     JOIN 
...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_48
     JOIN 
...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_46
     JOIN 
    (SELECT t.* 
    FROM orkut t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_44
...
FROM 
    ...
    JOIN (
     ...
     JOIN orkut AS t8 ON forceorder(t8.sub = intermediate_51.sub)) AS intermediate_64 JOIN 
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 583) c
        ON t.obj = c.val) AS intermediate_1
     JOIN orkut AS t3 ON forceorder(intermediate_1.sub = t3.obj)) AS intermediate_70 JOIN 
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 583) c
        ON t.sub = c.val) AS intermediate_3
     JOIN orkut AS t8 ON forceorder(intermediate_3.sub = t8.obj)) AS intermediate_71 JOIN 
...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_68
     JOIN 
...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_66
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_81.intermediate_80_intermediate_1_sub AS intermediate_81_intermediate_80_intermediate_1_sub,
       intermediate_81.intermediate_80_intermediate_79_t3_sub AS intermediate_81_intermediate_80_intermediate_79_t3_sub,
       intermediate_81.intermediate_78_intermediate_77_intermediate_67_obj AS intermediate_81_intermediate_78_intermediate_77_intermediate_67_obj,
       intermediate_81.intermediate_78_intermediate_77_intermediate_67_sub AS intermediate_81_intermediate_78_intermediate_77_intermediate_67_sub,
       intermediate_81.intermediate_78_intermediate_77_intermediate_47_obj AS intermediate_81_intermediate_78_intermediate_77_intermediate_47_obj,
       intermediate_81.intermediate_80_intermediate_79_intermediate_3_obj AS intermediate_81_intermediate_80_intermediate_79_intermediate_3_obj,
       intermediate_81.intermediate_80_intermediate_1_obj AS intermediate_81_intermediate_80_intermediate_1_obj,
       intermediate_81.intermediate_80_intermediate_79_t3_obj AS intermediate_81_intermediate_80_intermediate_79_t3_obj,
       intermediate_81.intermediate_78_intermediate_77_intermediate_47_sub AS intermediate_81_intermediate_78_intermediate_77_intermediate_47_sub,
       intermediate_81.intermediate_78_intermediate_45_sub AS intermediate_81_intermediate_78_intermediate_45_sub,
       intermediate_81.intermediate_80_intermediate_79_intermediate_3_sub AS intermediate_81_intermediate_80_intermediate_79_intermediate_3_sub,
       intermediate_81.intermediate_78_intermediate_45_obj AS intermediate_81_intermediate_78_intermediate_45_obj,
...
FROM 
    ...
    JOIN (
     ...
     JOIN orkut AS t8 ON forceorder(t8.sub = intermediate_69.sub)) AS intermediate_82 JOIN 
(SELECT intermediate_78.intermediate_77_intermediate_47_sub AS intermediate_78_intermediate_77_intermediate_47_sub,
       intermediate_78.intermediate_77_intermediate_47_obj AS intermediate_78_intermediate_77_intermediate_47_obj,
       intermediate_78.intermediate_45_obj AS intermediate_78_intermediate_45_obj,
       intermediate_78.intermediate_45_sub AS intermediate_78_intermediate_45_sub,
       intermediate_78.intermediate_77_intermediate_67_sub AS intermediate_78_intermediate_77_intermediate_67_sub,
       intermediate_78.intermediate_77_intermediate_67_obj AS intermediate_78_intermediate_77_intermediate_67_obj,
       intermediate_80.intermediate_1_sub AS intermediate_80_intermediate_1_sub,
       intermediate_80.intermediate_1_obj AS intermediate_80_intermediate_1_obj,
       intermediate_80.intermediate_79_t3_obj AS intermediate_80_intermediate_79_t3_obj,
       intermediate_80.intermediate_79_intermediate_3_obj AS intermediate_80_intermediate_79_intermediate_3_obj,
       intermediate_80.intermediate_79_intermediate_3_sub AS intermediate_80_intermediate_79_intermediate_3_sub,
       intermediate_80.intermediate_79_t3_sub AS intermediate_80_intermediate_79_t3_sub
FROM 
(SELECT intermediate_45.sub AS intermediate_45_sub,
       intermediate_45.obj AS intermediate_45_obj,
       intermediate_77.intermediate_67_sub AS intermediate_77_intermediate_67_sub,
       intermediate_77.intermediate_47_sub AS intermediate_77_intermediate_47_sub,
       intermediate_77.intermediate_67_obj AS intermediate_77_intermediate_67_obj,
       intermediate_77.intermediate_47_obj AS intermediate_77_intermediate_47_obj
FROM 
    (SELECT t.* 
    FROM orkut t
    JOIN (
...
FROM 
    ...
    JOIN (
     ...
     ON forceorder(intermediate_67.obj = intermediate_47.sub)) AS intermediate_77 ON forceorder(intermediate_45.obj = intermediate_77.intermediate_67_sub AND intermediate_45.sub = intermediate_77.intermediate_47_obj)) AS intermediate_78 JOIN 
(SELECT intermediate_1.sub AS intermediate_1_sub,
       intermediate_1.obj AS intermediate_1_obj,
       intermediate_79.intermediate_3_sub AS intermediate_79_intermediate_3_sub,
       intermediate_79.t3_sub AS intermediate_79_t3_sub,
       intermediate_79.t3_obj AS intermediate_79_t3_obj,
       intermediate_79.intermediate_3_obj AS intermediate_79_intermediate_3_obj
FROM 
    (SELECT t.* 
    FROM orkut t
    JOIN (
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 583) c
        ON t.sub = c.val) AS intermediate_3
     JOIN orkut AS t3 ON forceorder(intermediate_3.obj = t3.sub)) AS intermediate_79 ON forceorder(intermediate_1.obj = intermediate_79.intermediate_3_sub AND intermediate_1.sub = intermediate_79.t3_obj)) AS intermediate_80 ON forceorder(intermediate_78.intermediate_77_intermediate_67_obj = intermediate_80.intermediate_79_intermediate_3_obj)) AS intermediate_81 ON forceorder(intermediate_81.intermediate_80_intermediate_79_intermediate_3_sub = intermediate_82.t8_obj AND intermediate_81.intermediate_78_intermediate_77_intermediate_67_sub = intermediate_82.intermediate_69_obj)) AS intermediate_83
        ;