...
SELECT COUNT(*)
FROM 
(SELECT intermediate_14.intermediate_13_intermediate_12_intermediate_0_sub AS intermediate_14_intermediate_13_intermediate_12_intermediate_0_sub,
...
FROM 
(SELECT intermediate_16.intermediate_15_intermediate_6_sub AS intermediate_16_intermediate_15_intermediate_6_sub,
       ...
       intermediate_16.intermediate_8_sub AS intermediate_16_intermediate_8_sub,
...
(SELECT intermediate_13.intermediate_12_intermediate_2_sub AS intermediate_13_intermediate_12_intermediate_2_sub,
       ...
       t8.obj AS t8_obj,
       t8.sub AS t8_sub
FROM wgpb AS t8 JOIN 
(SELECT intermediate_12.intermediate_0_sub AS intermediate_12_intermediate_0_sub,
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_23.intermediate_22_intermediate_21_intermediate_9_obj AS intermediate_23_intermediate_22_intermediate_21_intermediate_9_obj,
       ...
       intermediate_23.intermediate_22_intermediate_21_intermediate_6_obj AS intermediate_23_intermediate_22_intermediate_21_intermediate_6_obj,
...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t8 ON forceorder(t8.sub = intermediate_11.sub)) AS intermediate_24 JOIN 
(SELECT intermediate_20.intermediate_19_intermediate_0_sub AS intermediate_20_intermediate_19_intermediate_0_sub,
       intermediate_20.intermediate_19_intermediate_2_sub AS intermediate_20_intermediate_19_intermediate_2_sub,
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_4
     JOIN 
(SELECT intermediate_9.obj AS intermediate_9_obj,
...
(SELECT intermediate_19.intermediate_0_sub AS intermediate_19_intermediate_0_sub,
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_32.intermediate_31_t3_sub AS intermediate_32_intermediate_31_t3_sub,
       ...
       intermediate_32.intermediate_31_intermediate_30_intermediate_0_sub AS intermediate_32_intermediate_31_intermediate_30_intermediate_0_sub,
...
FROM 
(SELECT intermediate_34.intermediate_33_intermediate_26_sub AS intermediate_34_intermediate_33_intermediate_26_sub,
       intermediate_34.intermediate_33_intermediate_7_sub AS intermediate_34_intermediate_33_intermediate_7_sub,
       intermediate_34.intermediate_33_intermediate_7_obj AS intermediate_34_intermediate_33_intermediate_7_obj,
...
FROM 
    ...
    FROM wgpb t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_28
     JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN 
(SELECT intermediate_26.obj AS intermediate_26_obj,
...
(SELECT intermediate_31.t3_sub AS intermediate_31_t3_sub,
       ...
       intermediate_31.intermediate_30_intermediate_2_obj AS intermediate_31_intermediate_30_intermediate_2_obj,
       intermediate_31.intermediate_30_intermediate_2_sub AS intermediate_31_intermediate_30_intermediate_2_sub,
       t8.obj AS t8_obj,
       t8.sub AS t8_sub
FROM wgpb AS t8 JOIN 
(SELECT intermediate_30.intermediate_0_sub AS intermediate_30_intermediate_0_sub,
       ...
       intermediate_30.intermediate_2_sub AS intermediate_30_intermediate_2_sub,
       t3.obj AS t3_obj,
       t3.sub AS t3_sub
FROM wgpb AS t3 JOIN 
(SELECT intermediate_0.obj AS intermediate_0_obj,
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_41.intermediate_40_intermediate_5_obj AS intermediate_41_intermediate_40_intermediate_5_obj,
       ...
       intermediate_41.intermediate_40_intermediate_39_intermediate_7_sub AS intermediate_41_intermediate_40_intermediate_39_intermediate_7_sub,
...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t8 ON forceorder(t8.sub = intermediate_29.sub)) AS intermediate_42 JOIN 
...
FROM 
    ...
    JOIN (
        ...
        ON t.sub = c.val) AS intermediate_5
     JOIN 
(SELECT intermediate_27.obj AS intermediate_27_obj,
...
(SELECT intermediate_37.intermediate_0_sub AS intermediate_37_intermediate_0_sub,
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_54.intermediate_53_intermediate_52_t3_obj AS intermediate_54_intermediate_53_intermediate_52_t3_obj,
       intermediate_54.t8_sub AS intermediate_54_t8_sub,
       intermediate_54.intermediate_53_intermediate_52_intermediate_3_obj AS intermediate_54_intermediate_53_intermediate_52_intermediate_3_obj,
...
FROM 
(SELECT intermediate_53.intermediate_1_obj AS intermediate_53_intermediate_1_obj,
       ...
       intermediate_53.intermediate_52_intermediate_3_obj AS intermediate_53_intermediate_52_intermediate_3_obj,
...
(SELECT intermediate_56.intermediate_55_intermediate_46_sub AS intermediate_56_intermediate_55_intermediate_46_sub,
       intermediate_56.intermediate_55_intermediate_44_sub AS intermediate_56_intermediate_55_intermediate_44_sub,
...
FROM 
    ...
    FROM wgpb t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_50
     JOIN 
(SELECT intermediate_48.obj AS intermediate_48_obj,
       intermediate_48.sub AS intermediate_48_sub,
...
FROM 
    ...
    FROM wgpb t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_48
     JOIN 
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_63.intermediate_62_intermediate_61_intermediate_46_obj AS intermediate_63_intermediate_62_intermediate_61_intermediate_46_obj,
       ...
       intermediate_63.intermediate_60_intermediate_1_obj AS intermediate_63_intermediate_60_intermediate_1_obj,
...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t8 ON forceorder(t8.sub = intermediate_51.sub)) AS intermediate_64 JOIN 
(SELECT intermediate_60.intermediate_59_t3_obj AS intermediate_60_intermediate_59_t3_obj,
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_44
     JOIN 
(SELECT intermediate_49.obj AS intermediate_49_obj,
       intermediate_49.sub AS intermediate_49_sub,
       intermediate_46.obj AS intermediate_46_obj,
       intermediate_46.sub AS intermediate_46_sub
FROM 
    (SELECT t.* 
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_70.intermediate_1_sub AS intermediate_70_intermediate_1_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 160) c
        ON t.obj = c.val) AS intermediate_1
     JOIN wgpb AS t3 ON forceorder(intermediate_1.sub = t3.obj)) AS intermediate_70 JOIN 
(SELECT intermediate_71.intermediate_3_obj AS intermediate_71_intermediate_3_obj,
       intermediate_71.t8_sub AS intermediate_71_t8_sub,
       intermediate_71.intermediate_3_sub AS intermediate_71_intermediate_3_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 160) c
        ON t.sub = c.val) AS intermediate_3
     JOIN wgpb AS t8 ON forceorder(intermediate_3.sub = t8.obj)) AS intermediate_71 JOIN 
(SELECT intermediate_73.intermediate_45_sub AS intermediate_73_intermediate_45_sub,
       ...
       intermediate_73.intermediate_72_intermediate_66_sub AS intermediate_73_intermediate_72_intermediate_66_sub,
...
FROM 
    ...
    FROM wgpb t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_68
     JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN 
(SELECT intermediate_66.obj AS intermediate_66_obj,
       intermediate_66.sub AS intermediate_66_sub,
...
FROM 
    ...
    FROM wgpb t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_66
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_81.intermediate_78_intermediate_77_intermediate_3_obj AS intermediate_81_intermediate_78_intermediate_77_intermediate_3_obj,
       ...
       intermediate_81.intermediate_78_intermediate_1_obj AS intermediate_81_intermediate_78_intermediate_1_obj,
...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t8 ON forceorder(t8.sub = intermediate_69.sub)) AS intermediate_82 JOIN 
(SELECT intermediate_78.intermediate_1_obj AS intermediate_78_intermediate_1_obj,
       ...
       intermediate_78.intermediate_1_sub AS intermediate_78_intermediate_1_sub,
...
FROM 
    ...
    JOIN (
        ...
        ON t.sub = c.val) AS intermediate_45
     JOIN 
(SELECT intermediate_67.obj AS intermediate_67_obj,
       intermediate_67.sub AS intermediate_67_sub,
       intermediate_47.obj AS intermediate_47_obj,
       intermediate_47.sub AS intermediate_47_sub
FROM 
    (SELECT t.* 
