...
JOIN (
 ...
 JOIN wgpb AS t8 ON forceorder(t8.sub = intermediate_11.sub)) AS intermediate_17 JOIN 
...
JOIN (
    ...
    WHERE s.cnt > 180) c
    ON t.obj = c.val) AS intermediate_1
 JOIN wgpb AS t3 ON forceorder(intermediate_1.sub = t3.obj)) AS intermediate_19 JOIN 
...
JOIN (
    ...
    WHERE s.cnt > 180) c
    ON t.sub = c.val) AS intermediate_3
 JOIN wgpb AS t8 ON forceorder(intermediate_3.sub = t8.obj)) AS intermediate_20 JOIN 
...
JOIN (
 ...
 JOIN wgpb AS t8 ON forceorder(t8.sub = intermediate_29.sub)) AS intermediate_35 JOIN 
...
FROM wgpb t
LEFT JOIN sub_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 180) AS intermediate_28
 JOIN 
...
JOIN (
 ...
 JOIN wgpb AS t8 ON forceorder(t8.sub = intermediate_51.sub)) AS intermediate_57 JOIN 
...
FROM wgpb t
LEFT JOIN sub_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 180) AS intermediate_50
 JOIN 
(SELECT intermediate_45.obj AS intermediate_45_obj,
       intermediate_45.sub AS intermediate_45_sub,
...
FROM wgpb t
LEFT JOIN sub_obj c ON t.sub = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 180) AS intermediate_48
...
JOIN (
 ...
 JOIN wgpb AS t8 ON forceorder(t8.sub = intermediate_69.sub)) AS intermediate_75 JOIN 
...
FROM wgpb t
LEFT JOIN sub_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 180) AS intermediate_68
 JOIN 
...
FROM wgpb t
LEFT JOIN sub_obj c ON t.sub = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 180) AS intermediate_66
 JOIN 
(SELECT intermediate_44.obj AS intermediate_44_obj,
       intermediate_44.sub AS intermediate_44_sub,
       intermediate_46.obj AS intermediate_46_obj,
