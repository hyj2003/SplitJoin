...
(SELECT intermediate_1.sub AS intermediate_1_sub,
       ...
       intermediate_4.intermediate_3_obj AS intermediate_4_intermediate_3_obj,
       intermediate_4.intermediate_3_sub AS intermediate_4_intermediate_3_sub
FROM 
(SELECT t.* 
FROM topcats t
JOIN (
...
JOIN (
 ...
 JOIN topcats AS t3 ON forceorder(intermediate_3.obj = t3.obj)) AS intermediate_4 ON forceorder(intermediate_1.obj = intermediate_4.intermediate_3_sub AND intermediate_1.sub = intermediate_4.t3_sub)) AS intermediate_5
;
SELECT COUNT(*)
FROM 
