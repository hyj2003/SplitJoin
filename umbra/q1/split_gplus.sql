...
JOIN (
 ...
 JOIN gplus AS t3 ON forceorder(intermediate_1.sub = t3.sub)) AS intermediate_4 ON forceorder(intermediate_3.sub = intermediate_4.intermediate_1_obj AND intermediate_3.obj = intermediate_4.t3_obj)) AS intermediate_5
;
SELECT COUNT(*)
FROM 
