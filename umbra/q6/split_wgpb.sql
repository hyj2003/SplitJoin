...
SELECT COUNT(*)
FROM 
(SELECT intermediate_10.intermediate_9_intermediate_8_intermediate_1_sub AS intermediate_10_intermediate_9_intermediate_8_intermediate_1_sub,
       intermediate_10.intermediate_9_intermediate_8_intermediate_5_obj AS intermediate_10_intermediate_9_intermediate_8_intermediate_5_obj,
       intermediate_10.intermediate_9_t5_sub AS intermediate_10_intermediate_9_t5_sub,
       ...
       intermediate_10.intermediate_9_intermediate_8_intermediate_5_sub AS intermediate_10_intermediate_9_intermediate_8_intermediate_5_sub,
       intermediate_10.intermediate_9_t5_obj AS intermediate_10_intermediate_9_t5_obj,
       intermediate_11.intermediate_7_sub AS intermediate_11_intermediate_7_sub,
       intermediate_11.intermediate_3_sub AS intermediate_11_intermediate_3_sub,
       intermediate_11.intermediate_3_obj AS intermediate_11_intermediate_3_obj,
       intermediate_11.intermediate_7_obj AS intermediate_11_intermediate_7_obj
FROM 
...
JOIN (
 ...
 ON forceorder(intermediate_3.obj = intermediate_7.obj)) AS intermediate_11 JOIN 
...
JOIN (
 ...
 ON forceorder(intermediate_1.sub = intermediate_5.sub)) AS intermediate_8 ON forceorder(intermediate_8.intermediate_5_obj = t5.obj)) AS intermediate_9 ON forceorder(t6.sub = intermediate_9.intermediate_8_intermediate_1_sub AND t6.sub = intermediate_9.intermediate_8_intermediate_5_sub)) AS intermediate_10 ON forceorder(intermediate_10.intermediate_9_t5_sub = intermediate_11.intermediate_3_sub AND intermediate_10.intermediate_9_intermediate_8_intermediate_1_obj = intermediate_11.intermediate_3_sub AND intermediate_10.t6_obj = intermediate_11.intermediate_3_obj AND intermediate_10.t6_obj = intermediate_11.intermediate_7_obj AND intermediate_10.intermediate_9_intermediate_8_intermediate_5_obj = intermediate_11.intermediate_7_sub)) AS intermediate_12
;
SELECT COUNT(*)
FROM 
(SELECT t6.obj AS t6_obj,
...
FROM wgpb t
LEFT JOIN sub_obj c ON t.sub = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 180) AS intermediate_20
 JOIN 
(SELECT t.* 
FROM wgpb t
LEFT JOIN sub_obj c ON t.obj = c.val
