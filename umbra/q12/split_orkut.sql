...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_22
...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_38
     JOIN 
    (SELECT t.* 
    FROM orkut t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_36
...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_54
...
FROM 
    ...
    FROM orkut t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_56
