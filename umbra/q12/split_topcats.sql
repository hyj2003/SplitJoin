...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_22
     ON forceorder(intermediate_7.obj = intermediate_22.sub)) AS intermediate_26 JOIN 
(SELECT intermediate_27.intermediate_0_obj AS intermediate_27_intermediate_0_obj,
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_24
...
(SELECT intermediate_44.intermediate_36_sub AS intermediate_44_intermediate_36_sub,
       ...
       intermediate_47.intermediate_46_intermediate_3_sub AS intermediate_47_intermediate_46_intermediate_3_sub,
       ...
       intermediate_47.intermediate_46_intermediate_45_intermediate_1_sub AS intermediate_47_intermediate_46_intermediate_45_intermediate_1_sub,
       intermediate_47.intermediate_40_obj AS intermediate_47_intermediate_40_obj,
       intermediate_47.intermediate_46_intermediate_45_intermediate_1_obj AS intermediate_47_intermediate_46_intermediate_45_intermediate_1_obj,
       intermediate_47.intermediate_46_intermediate_3_obj AS intermediate_47_intermediate_46_intermediate_3_obj
FROM 
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_38
     JOIN 
    (SELECT t.* 
    FROM topcats t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_36
...
(SELECT intermediate_40.sub AS intermediate_40_sub,
       ...
       intermediate_46.intermediate_3_sub AS intermediate_46_intermediate_3_sub,
       intermediate_46.intermediate_3_obj AS intermediate_46_intermediate_3_obj,
       intermediate_46.intermediate_45_intermediate_42_obj AS intermediate_46_intermediate_45_intermediate_42_obj,
       intermediate_46.intermediate_45_intermediate_1_sub AS intermediate_46_intermediate_45_intermediate_1_sub,
       intermediate_46.intermediate_45_intermediate_1_obj AS intermediate_46_intermediate_45_intermediate_1_obj,
       intermediate_46.intermediate_45_intermediate_42_sub AS intermediate_46_intermediate_45_intermediate_42_sub
FROM 
    (SELECT t.* 
    FROM topcats t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_40
     JOIN 
(SELECT intermediate_3.sub AS intermediate_3_sub,
       ...
       intermediate_45.intermediate_1_sub AS intermediate_45_intermediate_1_sub,
       intermediate_45.intermediate_1_obj AS intermediate_45_intermediate_1_obj
FROM 
    (SELECT t.* 
    FROM topcats t
    JOIN (
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_42
     ON forceorder(intermediate_1.obj = intermediate_42.obj)) AS intermediate_45 ON forceorder(intermediate_3.obj = intermediate_45.intermediate_1_sub AND intermediate_3.sub = intermediate_45.intermediate_42_sub)) AS intermediate_46 ON forceorder(intermediate_40.obj = intermediate_46.intermediate_3_sub AND intermediate_40.obj = intermediate_46.intermediate_45_intermediate_42_sub)) AS intermediate_47 ON forceorder(intermediate_44.intermediate_36_sub = intermediate_47.intermediate_46_intermediate_45_intermediate_1_obj AND intermediate_44.intermediate_36_sub = intermediate_47.intermediate_46_intermediate_45_intermediate_42_obj AND intermediate_44.intermediate_38_obj = intermediate_47.intermediate_40_sub)) AS intermediate_48
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.sub = c.val) AS intermediate_1
     ON forceorder(intermediate_1.obj = intermediate_43.obj)) AS intermediate_50 ON forceorder(intermediate_3.obj = intermediate_50.intermediate_1_sub AND intermediate_3.sub = intermediate_50.intermediate_43_sub)) AS intermediate_51 ON forceorder(intermediate_36.sub = intermediate_51.intermediate_50_intermediate_1_obj AND intermediate_36.sub = intermediate_51.intermediate_50_intermediate_43_obj)) AS intermediate_52 ON forceorder(intermediate_49.intermediate_38_sub = intermediate_52.intermediate_36_obj AND intermediate_49.intermediate_41_obj = intermediate_52.intermediate_51_intermediate_3_sub AND intermediate_49.intermediate_41_obj = intermediate_52.intermediate_51_intermediate_50_intermediate_43_sub)) AS intermediate_53
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT intermediate_58.intermediate_54_sub AS intermediate_58_intermediate_54_sub,
       ...
       intermediate_58.intermediate_39_obj AS intermediate_58_intermediate_39_obj,
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_54
...
FROM 
    ...
    FROM topcats t
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_56
     JOIN 
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.sub = c.val) AS intermediate_1
     ON forceorder(intermediate_1.obj = intermediate_57.obj)) AS intermediate_64 ON forceorder(intermediate_3.obj = intermediate_64.intermediate_1_sub AND intermediate_3.sub = intermediate_64.intermediate_57_sub)) AS intermediate_65 ON forceorder(intermediate_37.sub = intermediate_65.intermediate_64_intermediate_1_obj AND intermediate_37.sub = intermediate_65.intermediate_64_intermediate_57_obj)) AS intermediate_66 ON forceorder(intermediate_63.intermediate_39_sub = intermediate_66.intermediate_37_obj AND intermediate_63.intermediate_55_obj = intermediate_66.intermediate_65_intermediate_3_sub AND intermediate_63.intermediate_55_obj = intermediate_66.intermediate_65_intermediate_64_intermediate_57_sub)) AS intermediate_67
        ;