...
SELECT COUNT(*)
FROM 
(SELECT intermediate_9.intermediate_8_t5_sub AS intermediate_9_intermediate_8_t5_sub,
       ...
       intermediate_9.intermediate_1_sub AS intermediate_9_intermediate_1_sub,
       intermediate_9.intermediate_8_intermediate_3_obj AS intermediate_9_intermediate_8_intermediate_3_obj,
       intermediate_9.intermediate_1_obj AS intermediate_9_intermediate_1_obj,
...
JOIN (
 ...
 JOIN topcats AS t2 ON forceorder(intermediate_7.obj = t2.obj)) AS intermediate_10 ON forceorder(intermediate_5.obj = intermediate_10.intermediate_7_sub AND intermediate_5.sub = intermediate_10.t2_sub)) AS intermediate_11 JOIN 
...
JOIN (
 ...
 JOIN topcats AS t5 ON forceorder(t5.obj = intermediate_3.obj)) AS intermediate_8 ON forceorder(intermediate_1.obj = intermediate_8.intermediate_3_sub AND intermediate_1.sub = intermediate_8.t5_sub)) AS intermediate_9 ON forceorder(intermediate_9.intermediate_8_t5_sub = intermediate_11.intermediate_10_intermediate_7_obj AND intermediate_9.intermediate_1_sub = intermediate_11.intermediate_10_t2_obj)) AS intermediate_12
;
SELECT COUNT(*)
FROM 
(SELECT intermediate_14.intermediate_1_sub AS intermediate_14_intermediate_1_sub,
...
(SELECT intermediate_1.obj AS intermediate_1_obj,
       intermediate_1.sub AS intermediate_1_sub,
       intermediate_13.t5_sub AS intermediate_13_t5_sub,
...
JOIN (
    ...
    WHERE s.cnt > 323) c
    ON t.sub = c.val) AS intermediate_3
 JOIN topcats AS t5 ON forceorder(t5.obj = intermediate_3.obj)) AS intermediate_13 ON forceorder(intermediate_1.obj = intermediate_13.intermediate_3_sub AND intermediate_1.sub = intermediate_13.t5_sub)) AS intermediate_14 JOIN 
...
(SELECT intermediate_23.t5_sub AS intermediate_23_t5_sub,
       ...
       intermediate_25.intermediate_19_sub AS intermediate_25_intermediate_19_sub,
       intermediate_25.intermediate_19_obj AS intermediate_25_intermediate_19_obj,
...
JOIN (
 ...
 JOIN topcats AS t2 ON forceorder(intermediate_21.obj = t2.obj)) AS intermediate_24 ON forceorder(intermediate_19.obj = intermediate_24.intermediate_21_sub AND intermediate_19.sub = intermediate_24.t2_sub)) AS intermediate_25 JOIN 
(SELECT t5.obj AS t5_obj,
       t5.sub AS t5_sub,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_0
 ON forceorder(intermediate_0.obj = intermediate_2.sub)) AS intermediate_22 ON forceorder(t5.obj = intermediate_22.intermediate_2_obj AND t5.sub = intermediate_22.intermediate_0_sub)) AS intermediate_23 ON forceorder(intermediate_23.t5_sub = intermediate_25.intermediate_24_intermediate_21_obj AND intermediate_23.intermediate_22_intermediate_0_sub = intermediate_25.intermediate_24_t2_obj)) AS intermediate_26
;
SELECT COUNT(*)
FROM 
