...
\echo join time:
EXPLAIN ANALYZE EXPLAIN ANALYZE SELECT COUNT(*) FROM uspatent AS t1, uspatent AS t2, uspatent AS t3, uspatent AS t4
WHERE t1.obj = t2.sub AND t2.obj = t3.obj AND t4.obj = t3.sub AND t4.sub = t1.sub;;