...
JOIN (
 ...
 ON forceorder(intermediate_3.obj = intermediate_7.obj)) AS intermediate_8 JOIN 
...
JOIN (
 ...
 ON forceorder(intermediate_1.sub = intermediate_5.sub)) AS intermediate_9 ON forceorder(intermediate_8.intermediate_3_sub = intermediate_9.intermediate_1_obj AND intermediate_8.intermediate_7_sub = intermediate_9.intermediate_5_obj)) AS intermediate_10
;
SELECT COUNT(*)
FROM 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_6
 ON forceorder(intermediate_3.obj = intermediate_6.obj)) AS intermediate_11 JOIN 
(SELECT intermediate_1.obj AS intermediate_1_obj,
       intermediate_1.sub AS intermediate_1_sub,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_4
 ON forceorder(intermediate_1.sub = intermediate_4.sub)) AS intermediate_12 ON forceorder(intermediate_11.intermediate_3_sub = intermediate_12.intermediate_1_obj AND intermediate_11.intermediate_6_sub = intermediate_12.intermediate_4_obj)) AS intermediate_13
;
SELECT COUNT(*)
FROM 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_2
 ON forceorder(intermediate_2.obj = intermediate_17.obj)) AS intermediate_18 JOIN 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_0
 ON forceorder(intermediate_0.sub = intermediate_15.sub)) AS intermediate_19 ON forceorder(intermediate_18.intermediate_2_sub = intermediate_19.intermediate_0_obj AND intermediate_18.intermediate_17_sub = intermediate_19.intermediate_15_obj)) AS intermediate_20
;
SELECT COUNT(*)
FROM 
...
FROM topcats t
LEFT JOIN sub_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_14
 JOIN 
(SELECT t.* 
FROM topcats t
LEFT JOIN sub_obj c ON t.sub = c.val
