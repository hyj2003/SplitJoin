...
SELECT COUNT(*)
FROM 
(SELECT intermediate_8.intermediate_7_obj AS intermediate_8_intermediate_7_obj,
...
JOIN (
 ...
 ON forceorder(intermediate_1.sub = intermediate_5.sub)) AS intermediate_9 JOIN 
...
JOIN (
 ...
 ON forceorder(intermediate_3.obj = intermediate_7.obj)) AS intermediate_8 ON forceorder(intermediate_8.intermediate_3_sub = intermediate_9.intermediate_1_obj AND intermediate_8.intermediate_7_sub = intermediate_9.intermediate_5_obj)) AS intermediate_10
;
SELECT COUNT(*)
FROM 
(SELECT intermediate_11.intermediate_6_obj AS intermediate_11_intermediate_6_obj,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_4
 ON forceorder(intermediate_1.sub = intermediate_4.sub)) AS intermediate_12 JOIN 
(SELECT intermediate_3.obj AS intermediate_3_obj,
       intermediate_3.sub AS intermediate_3_sub,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_6
 ON forceorder(intermediate_3.obj = intermediate_6.obj)) AS intermediate_11 ON forceorder(intermediate_11.intermediate_3_sub = intermediate_12.intermediate_1_obj AND intermediate_11.intermediate_6_sub = intermediate_12.intermediate_4_obj)) AS intermediate_13
;
SELECT COUNT(*)
FROM 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_0
 ON forceorder(intermediate_0.sub = intermediate_15.sub)) AS intermediate_19 JOIN 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_2
 ON forceorder(intermediate_2.obj = intermediate_17.obj)) AS intermediate_18 ON forceorder(intermediate_18.intermediate_2_sub = intermediate_19.intermediate_0_obj AND intermediate_18.intermediate_17_sub = intermediate_19.intermediate_15_obj)) AS intermediate_20
;
SELECT COUNT(*)
FROM 
...
FROM orkut t
LEFT JOIN sub_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_14
 JOIN 
(SELECT t.* 
FROM orkut t
LEFT JOIN sub_obj c ON t.sub = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_16
 ON forceorder(intermediate_16.sub = intermediate_14.obj)) AS intermediate_22 JOIN 
(SELECT intermediate_0.obj AS intermediate_0_obj,
       intermediate_0.sub AS intermediate_0_sub,
...
LEFT JOIN sub_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 583) AS intermediate_0
 ON forceorder(intermediate_0.obj = intermediate_2.sub)) AS intermediate_21 ON forceorder(intermediate_21.intermediate_2_obj = intermediate_22.intermediate_16_obj AND intermediate_21.intermediate_0_sub = intermediate_22.intermediate_14_sub)) AS intermediate_23
;