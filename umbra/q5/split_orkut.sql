...
FROM 
    ...
    JOIN (
     ...
     JOIN orkut AS t2 ON forceorder(intermediate_1.sub = t2.sub)) AS intermediate_20 ON forceorder(intermediate_20.intermediate_1_obj = intermediate_22.intermediate_21_intermediate_3_sub AND intermediate_20.t2_obj = intermediate_22.intermediate_21_intermediate_3_obj AND intermediate_20.t2_obj = intermediate_22.intermediate_21_intermediate_18_obj AND intermediate_20.intermediate_1_obj = intermediate_22.intermediate_16_sub)) AS intermediate_23
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT t2.sub AS t2_sub,
