...
SELECT COUNT(*)
FROM 
(SELECT intermediate_9.t2_obj AS intermediate_9_t2_obj,
       ...
       intermediate_9.t2_sub AS intermediate_9_t2_sub,
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_0
     ON forceorder(intermediate_0.obj = intermediate_2.sub)) AS intermediate_8 ON forceorder(t2.sub = intermediate_8.intermediate_0_sub AND t2.obj = intermediate_8.intermediate_2_obj)) AS intermediate_9 JOIN 
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_4
     ON forceorder(intermediate_4.obj = intermediate_6.sub)) AS intermediate_10 ON forceorder(intermediate_9.intermediate_8_intermediate_0_obj = intermediate_10.intermediate_4_sub AND intermediate_9.intermediate_8_intermediate_2_sub = intermediate_10.intermediate_4_sub AND intermediate_9.t2_obj = intermediate_10.intermediate_6_obj AND intermediate_9.intermediate_8_intermediate_2_obj = intermediate_10.intermediate_6_obj)) AS intermediate_11
        ;
SELECT COUNT(*)
FROM 
(SELECT t2.obj AS t2_obj,
       ...
       intermediate_14.intermediate_0_obj AS intermediate_14_intermediate_0_obj,
       ...
       intermediate_14.intermediate_13_intermediate_12_intermediate_5_obj AS intermediate_14_intermediate_13_intermediate_12_intermediate_5_obj,
       intermediate_14.intermediate_13_intermediate_7_obj AS intermediate_14_intermediate_13_intermediate_7_obj,
       intermediate_14.intermediate_13_intermediate_12_intermediate_5_sub AS intermediate_14_intermediate_13_intermediate_12_intermediate_5_sub,
       intermediate_14.intermediate_0_sub AS intermediate_14_intermediate_0_sub
FROM wgpb AS t2 JOIN 
(SELECT intermediate_0.obj AS intermediate_0_obj,
       intermediate_0.sub AS intermediate_0_sub,
...
FROM 
    ...
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_2
     ON forceorder(intermediate_2.sub = intermediate_5.sub)) AS intermediate_12 ON forceorder(intermediate_12.intermediate_2_obj = intermediate_7.obj AND intermediate_12.intermediate_5_obj = intermediate_7.sub)) AS intermediate_13 ON forceorder(intermediate_0.obj = intermediate_13.intermediate_12_intermediate_2_sub AND intermediate_0.obj = intermediate_13.intermediate_12_intermediate_5_sub)) AS intermediate_14 ON forceorder(t2.sub = intermediate_14.intermediate_0_sub AND t2.obj = intermediate_14.intermediate_13_intermediate_12_intermediate_2_obj AND t2.obj = intermediate_14.intermediate_13_intermediate_7_obj)) AS intermediate_15
        ;
SELECT COUNT(*)
FROM 
(SELECT intermediate_21.intermediate_20_intermediate_3_obj AS intermediate_21_intermediate_20_intermediate_3_obj,
       intermediate_21.intermediate_20_intermediate_3_sub AS intermediate_21_intermediate_20_intermediate_3_sub,
       intermediate_21.intermediate_20_intermediate_18_sub AS intermediate_21_intermediate_20_intermediate_18_sub,
       intermediate_21.intermediate_16_sub AS intermediate_21_intermediate_16_sub,
       intermediate_21.intermediate_20_intermediate_18_obj AS intermediate_21_intermediate_20_intermediate_18_obj,
       intermediate_21.intermediate_16_obj AS intermediate_21_intermediate_16_obj,
       ...
       intermediate_22.t2_sub AS intermediate_22_t2_sub,
       intermediate_22.t2_obj AS intermediate_22_t2_obj
FROM 
...
FROM 
    ...
    FROM wgpb t
    LEFT JOIN sub_obj c ON t.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_16
     JOIN 
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 160) AS intermediate_18
     ON forceorder(intermediate_3.obj = intermediate_18.obj)) AS intermediate_20 ON forceorder(intermediate_16.sub = intermediate_20.intermediate_3_sub AND intermediate_16.obj = intermediate_20.intermediate_18_sub)) AS intermediate_21 JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t2 ON forceorder(intermediate_1.sub = t2.sub)) AS intermediate_22 ON forceorder(intermediate_21.intermediate_20_intermediate_3_sub = intermediate_22.intermediate_1_obj AND intermediate_21.intermediate_16_sub = intermediate_22.intermediate_1_obj AND intermediate_21.intermediate_20_intermediate_3_obj = intermediate_22.t2_obj AND intermediate_21.intermediate_20_intermediate_18_obj = intermediate_22.t2_obj)) AS intermediate_23
        ;
SELECT COUNT(*)
FROM 
(SELECT t2.obj AS t2_obj,
       t2.sub AS t2_sub,
       intermediate_26.intermediate_25_intermediate_24_intermediate_3_obj AS intermediate_26_intermediate_25_intermediate_24_intermediate_3_obj,
       intermediate_26.intermediate_1_sub AS intermediate_26_intermediate_1_sub,
       intermediate_26.intermediate_25_intermediate_19_sub AS intermediate_26_intermediate_25_intermediate_19_sub,
       intermediate_26.intermediate_25_intermediate_19_obj AS intermediate_26_intermediate_25_intermediate_19_obj,
       intermediate_26.intermediate_25_intermediate_24_intermediate_17_obj AS intermediate_26_intermediate_25_intermediate_24_intermediate_17_obj,
       intermediate_26.intermediate_25_intermediate_24_intermediate_3_sub AS intermediate_26_intermediate_25_intermediate_24_intermediate_3_sub,
       intermediate_26.intermediate_25_intermediate_24_intermediate_17_sub AS intermediate_26_intermediate_25_intermediate_24_intermediate_17_sub,
...
(SELECT intermediate_1.obj AS intermediate_1_obj,
       ...
       intermediate_25.intermediate_24_intermediate_17_obj AS intermediate_25_intermediate_24_intermediate_17_obj,
       intermediate_25.intermediate_24_intermediate_3_sub AS intermediate_25_intermediate_24_intermediate_3_sub,
       intermediate_25.intermediate_24_intermediate_17_sub AS intermediate_25_intermediate_24_intermediate_17_sub,
...
FROM 
    ...
    JOIN (
        ...
        ON t.obj = c.val) AS intermediate_1
     JOIN 
(SELECT intermediate_24.intermediate_17_obj AS intermediate_24_intermediate_17_obj,
       ...
       intermediate_24.intermediate_17_sub AS intermediate_24_intermediate_17_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 160) c
        ON t.sub = c.val) AS intermediate_3
     ON forceorder(intermediate_3.sub = intermediate_17.sub)) AS intermediate_24 ON forceorder(intermediate_24.intermediate_3_obj = intermediate_19.obj AND intermediate_24.intermediate_17_obj = intermediate_19.sub)) AS intermediate_25 ON forceorder(intermediate_1.obj = intermediate_25.intermediate_24_intermediate_3_sub AND intermediate_1.obj = intermediate_25.intermediate_24_intermediate_17_sub)) AS intermediate_26 ON forceorder(t2.sub = intermediate_26.intermediate_1_sub AND t2.obj = intermediate_26.intermediate_25_intermediate_24_intermediate_3_obj AND t2.obj = intermediate_26.intermediate_25_intermediate_19_obj)) AS intermediate_27
        ;