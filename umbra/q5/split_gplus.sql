...
SELECT COUNT(*)
FROM 
(SELECT intermediate_9.t2_sub AS intermediate_9_t2_sub,
       ...
       intermediate_9.t2_obj AS intermediate_9_t2_obj,
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 862) AS intermediate_0
     JOIN 
(SELECT intermediate_12.intermediate_2_obj AS intermediate_12_intermediate_2_obj,
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_20.t2_sub AS intermediate_20_t2_sub,
       ...
       intermediate_20.t2_obj AS intermediate_20_t2_obj,
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 862) AS intermediate_18
     ON forceorder(intermediate_3.obj = intermediate_18.obj)) AS intermediate_21 ON forceorder(intermediate_16.sub = intermediate_21.intermediate_3_sub AND intermediate_16.obj = intermediate_21.intermediate_18_sub)) AS intermediate_22 JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN gplus AS t2 ON forceorder(intermediate_1.sub = t2.sub)) AS intermediate_20 ON forceorder(intermediate_20.intermediate_1_obj = intermediate_22.intermediate_21_intermediate_3_sub AND intermediate_20.t2_obj = intermediate_22.intermediate_21_intermediate_3_obj AND intermediate_20.t2_obj = intermediate_22.intermediate_21_intermediate_18_obj AND intermediate_20.intermediate_1_obj = intermediate_22.intermediate_16_sub)) AS intermediate_23
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT t2.sub AS t2_sub,
...
(SELECT intermediate_24.intermediate_3_obj AS intermediate_24_intermediate_3_obj,
       ...
       intermediate_24.intermediate_17_obj AS intermediate_24_intermediate_17_obj,
