...
SELECT COUNT(*)
FROM 
(SELECT intermediate_8.intermediate_3_obj AS intermediate_8_intermediate_3_obj,
...
JOIN (
 ...
 ON forceorder(intermediate_1.obj = intermediate_5.sub)) AS intermediate_9 JOIN 
...
JOIN (
 ...
 ON forceorder(intermediate_3.sub = intermediate_7.sub)) AS intermediate_8 ON forceorder(intermediate_8.intermediate_3_obj = intermediate_9.intermediate_1_sub AND intermediate_8.intermediate_7_obj = intermediate_9.intermediate_5_obj)) AS intermediate_10
;
SELECT COUNT(*)
FROM 
(SELECT intermediate_11.intermediate_3_obj AS intermediate_11_intermediate_3_obj,
       intermediate_11.intermediate_6_obj AS intermediate_11_intermediate_6_obj,
       intermediate_11.intermediate_3_sub AS intermediate_11_intermediate_3_sub,
       intermediate_11.intermediate_6_sub AS intermediate_11_intermediate_6_sub,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 579) AS intermediate_4
 ON forceorder(intermediate_1.obj = intermediate_4.sub)) AS intermediate_12 JOIN 
(SELECT intermediate_3.sub AS intermediate_3_sub,
       intermediate_3.obj AS intermediate_3_obj,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 579) AS intermediate_6
 ON forceorder(intermediate_3.sub = intermediate_6.sub)) AS intermediate_11 ON forceorder(intermediate_11.intermediate_3_obj = intermediate_12.intermediate_1_sub AND intermediate_11.intermediate_6_obj = intermediate_12.intermediate_4_obj)) AS intermediate_13
;
SELECT COUNT(*)
FROM 
(SELECT intermediate_18.intermediate_2_obj AS intermediate_18_intermediate_2_obj,
       intermediate_18.intermediate_17_sub AS intermediate_18_intermediate_17_sub,
       intermediate_18.intermediate_17_obj AS intermediate_18_intermediate_17_obj,
       intermediate_18.intermediate_2_sub AS intermediate_18_intermediate_2_sub,
       intermediate_19.intermediate_15_obj AS intermediate_19_intermediate_15_obj,
       intermediate_19.intermediate_0_sub AS intermediate_19_intermediate_0_sub,
       intermediate_19.intermediate_15_sub AS intermediate_19_intermediate_15_sub,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_0
 ON forceorder(intermediate_0.obj = intermediate_15.sub)) AS intermediate_19 JOIN 
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_2
 ON forceorder(intermediate_2.sub = intermediate_17.sub)) AS intermediate_18 ON forceorder(intermediate_18.intermediate_2_obj = intermediate_19.intermediate_0_sub AND intermediate_18.intermediate_17_obj = intermediate_19.intermediate_15_obj)) AS intermediate_20
;
SELECT COUNT(*)
FROM 
...
LEFT JOIN sub_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_2
 ON forceorder(intermediate_2.obj = intermediate_0.sub)) AS intermediate_21 JOIN 
...
FROM topcats t
LEFT JOIN group_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 579) AS intermediate_14
 JOIN 
(SELECT t.* 
FROM topcats t
LEFT JOIN group_obj c ON t.obj = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 579) AS intermediate_16
 ON forceorder(intermediate_16.obj = intermediate_14.obj)) AS intermediate_22 ON forceorder(intermediate_21.intermediate_2_sub = intermediate_22.intermediate_16_sub AND intermediate_21.intermediate_0_obj = intermediate_22.intermediate_14_sub)) AS intermediate_23
;