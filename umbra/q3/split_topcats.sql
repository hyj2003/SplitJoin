...
SELECT COUNT(*)
FROM 
(SELECT intermediate_11.intermediate_2_sub AS intermediate_11_intermediate_2_sub,
       intermediate_11.intermediate_2_obj AS intermediate_11_intermediate_2_obj,
