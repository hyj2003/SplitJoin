...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t3 ON forceorder(intermediate_1.sub = t3.sub)) AS intermediate_6 ON forceorder(intermediate_3.sub = intermediate_6.intermediate_1_obj AND intermediate_3.obj = intermediate_6.t3_obj)) AS intermediate_7
        ;