...
FROM 
(SELECT intermediate_9.intermediate_4_obj AS intermediate_9_intermediate_4_obj,
...
(SELECT intermediate_2.sub AS intermediate_2_sub,
       ...
       intermediate_14.intermediate_13_intermediate_12_t4_sub AS intermediate_14_intermediate_13_intermediate_12_t4_sub,
       intermediate_14.intermediate_13_intermediate_12_t4_obj AS intermediate_14_intermediate_13_intermediate_12_t4_obj,
...
(SELECT intermediate_0.sub AS intermediate_0_sub,
       ...
       intermediate_13.intermediate_12_t4_sub AS intermediate_13_intermediate_12_t4_sub,
       intermediate_13.intermediate_5_obj AS intermediate_13_intermediate_5_obj,
       intermediate_13.intermediate_12_t4_obj AS intermediate_13_intermediate_12_t4_obj,
...
(SELECT intermediate_5.sub AS intermediate_5_sub,
       ...
       intermediate_12.t4_obj AS intermediate_12_t4_obj,
       intermediate_12.t4_sub AS intermediate_12_t4_sub,
...
FROM 
    ...
    JOIN (
     ...
     JOIN skitter AS t4 ON forceorder(intermediate_7.obj = t4.sub)) AS intermediate_12 ON forceorder(intermediate_5.sub = intermediate_12.intermediate_7_sub AND intermediate_5.obj = intermediate_12.t4_obj)) AS intermediate_13 ON forceorder(intermediate_0.obj = intermediate_13.intermediate_12_intermediate_7_sub AND intermediate_0.obj = intermediate_13.intermediate_5_sub)) AS intermediate_14 ON forceorder(intermediate_2.sub = intermediate_14.intermediate_0_sub AND intermediate_2.obj = intermediate_14.intermediate_13_intermediate_12_intermediate_7_obj AND intermediate_2.obj = intermediate_14.intermediate_13_intermediate_12_t4_sub)) AS intermediate_15
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT intermediate_22.intermediate_21_intermediate_20_intermediate_1_sub AS intermediate_22_intermediate_21_intermediate_20_intermediate_1_sub,
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_26.intermediate_25_intermediate_3_obj AS intermediate_26_intermediate_25_intermediate_3_obj,
       ...
       t4.obj AS t4_obj
FROM skitter AS t4 JOIN 
(SELECT intermediate_25.intermediate_3_obj AS intermediate_25_intermediate_3_obj,
