...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 579) AS intermediate_4
     ON forceorder(intermediate_4.obj = intermediate_6.obj)) AS intermediate_10 ON forceorder(intermediate_9.intermediate_8_intermediate_0_obj = intermediate_10.intermediate_4_sub AND intermediate_9.intermediate_8_intermediate_2_sub = intermediate_10.intermediate_4_sub AND intermediate_9.t2_obj = intermediate_10.intermediate_6_sub AND intermediate_9.intermediate_8_intermediate_2_obj = intermediate_10.intermediate_6_sub)) AS intermediate_11
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT t2.sub AS t2_sub,
       ...
       intermediate_14.intermediate_13_intermediate_12_intermediate_7_obj AS intermediate_14_intermediate_13_intermediate_12_intermediate_7_obj,
       ...
       intermediate_14.intermediate_13_intermediate_12_intermediate_7_sub AS intermediate_14_intermediate_13_intermediate_12_intermediate_7_sub,
...
FROM 
    ...
    LEFT JOIN sub_obj c ON t.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 323) AS intermediate_2
     ON forceorder(intermediate_2.obj = intermediate_7.sub)) AS intermediate_12 ON forceorder(intermediate_5.sub = intermediate_12.intermediate_2_sub AND intermediate_5.obj = intermediate_12.intermediate_7_obj)) AS intermediate_13 ON forceorder(intermediate_0.obj = intermediate_13.intermediate_12_intermediate_2_sub AND intermediate_0.obj = intermediate_13.intermediate_5_sub)) AS intermediate_14 ON forceorder(t2.sub = intermediate_14.intermediate_0_sub AND t2.obj = intermediate_14.intermediate_13_intermediate_12_intermediate_2_obj AND t2.obj = intermediate_14.intermediate_13_intermediate_12_intermediate_7_sub)) AS intermediate_15
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT intermediate_20.intermediate_1_obj AS intermediate_20_intermediate_1_obj,
       ...
       intermediate_20.t2_sub AS intermediate_20_t2_sub,
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 579) AS intermediate_18
     ON forceorder(intermediate_3.obj = intermediate_18.sub)) AS intermediate_21 ON forceorder(intermediate_16.sub = intermediate_21.intermediate_3_sub AND intermediate_16.obj = intermediate_21.intermediate_18_obj)) AS intermediate_22 JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t2 ON forceorder(intermediate_1.sub = t2.sub)) AS intermediate_20 ON forceorder(intermediate_20.intermediate_1_obj = intermediate_22.intermediate_21_intermediate_3_sub AND intermediate_20.t2_obj = intermediate_22.intermediate_21_intermediate_3_obj AND intermediate_20.t2_obj = intermediate_22.intermediate_21_intermediate_18_sub AND intermediate_20.intermediate_1_obj = intermediate_22.intermediate_16_sub)) AS intermediate_23
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
(SELECT t2.sub AS t2_sub,
       ...
       intermediate_26.intermediate_25_intermediate_17_obj AS intermediate_26_intermediate_25_intermediate_17_obj,
       intermediate_26.intermediate_25_intermediate_17_sub AS intermediate_26_intermediate_25_intermediate_17_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 323) c
        ON t.sub = c.val) AS intermediate_3
     ON forceorder(intermediate_3.obj = intermediate_19.sub)) AS intermediate_24 ON forceorder(intermediate_17.sub = intermediate_24.intermediate_3_sub AND intermediate_17.obj = intermediate_24.intermediate_19_obj)) AS intermediate_25 ON forceorder(intermediate_1.obj = intermediate_25.intermediate_24_intermediate_3_sub AND intermediate_1.obj = intermediate_25.intermediate_17_sub)) AS intermediate_26 ON forceorder(t2.sub = intermediate_26.intermediate_1_sub AND t2.obj = intermediate_26.intermediate_25_intermediate_24_intermediate_3_obj AND t2.obj = intermediate_26.intermediate_25_intermediate_24_intermediate_19_sub)) AS intermediate_27
        ;