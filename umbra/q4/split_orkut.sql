...
FROM 
    ...
    JOIN (
     ...
     JOIN orkut AS t4 ON forceorder(intermediate_5.obj = t4.obj)) AS intermediate_14 ON forceorder(intermediate_13.intermediate_0_obj = intermediate_14.intermediate_5_sub AND intermediate_13.intermediate_12_intermediate_7_sub = intermediate_14.intermediate_5_sub AND intermediate_13.intermediate_12_intermediate_2_obj = intermediate_14.t4_sub AND intermediate_13.intermediate_12_intermediate_7_obj = intermediate_14.t4_sub)) AS intermediate_15
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
