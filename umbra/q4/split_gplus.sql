...
FROM 
    ...
    JOIN (
     ...
     JOIN gplus AS t4 ON forceorder(intermediate_5.obj = t4.obj)) AS intermediate_14 ON forceorder(intermediate_13.intermediate_0_obj = intermediate_14.intermediate_5_sub AND intermediate_13.intermediate_12_intermediate_7_sub = intermediate_14.intermediate_5_sub AND intermediate_13.intermediate_12_intermediate_2_obj = intermediate_14.t4_sub AND intermediate_13.intermediate_12_intermediate_7_obj = intermediate_14.t4_sub)) AS intermediate_15
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 1526) AS intermediate_18
     ON forceorder(intermediate_1.obj = intermediate_18.sub)) AS intermediate_20 ON forceorder(intermediate_3.sub = intermediate_20.intermediate_1_sub AND intermediate_3.obj = intermediate_20.intermediate_18_obj)) AS intermediate_21 JOIN 
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 1526) AS intermediate_16
     JOIN gplus AS t4 ON forceorder(intermediate_16.obj = t4.obj)) AS intermediate_22 ON forceorder(intermediate_21.intermediate_20_intermediate_1_obj = intermediate_22.intermediate_16_sub AND intermediate_21.intermediate_20_intermediate_18_sub = intermediate_22.intermediate_16_sub AND intermediate_21.intermediate_3_obj = intermediate_22.t4_sub AND intermediate_21.intermediate_20_intermediate_18_obj = intermediate_22.t4_sub)) AS intermediate_23
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
