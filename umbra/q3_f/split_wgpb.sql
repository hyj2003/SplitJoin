...
--     WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 201) AS intermediate_0
--      JOIN 
--     (SELECT t2.* 
--     FROM wgpb AS t2
--     LEFT JOIN sub_obj_0 c ON t2.sub = c.val
--     WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 201) AS intermediate_2
--      ON forceorder(intermediate_0.sub = intermediate_2.sub)) AS intermediate_8 JOIN 
...
--     (SELECT t4.* 
--     FROM wgpb AS t4
--     LEFT JOIN sub_obj_2 c ON t4.sub = c.val
--     WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 97) AS intermediate_6
--      JOIN 
--     (SELECT t3.* 
--     FROM wgpb AS t3
--     LEFT JOIN sub_obj_2 c ON t3.obj = c.val
--     WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 97) AS intermediate_4
--      ON forceorder(intermediate_4.obj = intermediate_6.sub)) AS intermediate_9 ON forceorder(intermediate_8.intermediate_0_obj = intermediate_9.intermediate_4_sub AND intermediate_8.intermediate_2_obj = intermediate_9.intermediate_6_obj)) AS intermediate_10
--         ;
-- SELECT COUNT(*)
-- FROM 
-- (SELECT intermediate_11.intermediate_5_obj AS intermediate_11_intermediate_5_obj,
--        intermediate_11.intermediate_0_obj AS intermediate_11_intermediate_0_obj,
--        intermediate_11.intermediate_5_sub AS intermediate_11_intermediate_5_sub,
--        intermediate_11.intermediate_0_sub AS intermediate_11_intermediate_0_sub,
...
--         FROM sub_obj_2 s
--         WHERE s.cnt > 97) c
--         ON t3.obj = c.val) AS intermediate_5
--      JOIN 
--     (SELECT t1.* 
--     FROM (SELECT sub, obj FROM wgpb WHERE
--     ascii(substring(md5(sub), 1, 1)) % 3 = 1) AS t1
--     LEFT JOIN sub_obj_0 c ON t1.sub = c.val
--     WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 201) AS intermediate_0
--      ON forceorder(intermediate_0.obj = intermediate_5.sub)) AS intermediate_11 JOIN 
...
--         FROM sub_obj_2 s
--         WHERE s.cnt > 97) c
--         ON t4.sub = c.val) AS intermediate_7
--      JOIN 
--     (SELECT t2.* 
--     FROM wgpb AS t2
--     LEFT JOIN sub_obj_0 c ON t2.sub = c.val
--     WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 201) AS intermediate_2
--      ON forceorder(intermediate_2.obj = intermediate_7.obj)) AS intermediate_12 ON forceorder(intermediate_11.intermediate_0_sub = intermediate_12.intermediate_2_sub AND intermediate_11.intermediate_5_obj = intermediate_12.intermediate_7_sub)) AS intermediate_13
--         ;
-- SELECT COUNT(*)
-- FROM 
-- (SELECT intermediate_18.intermediate_14_sub AS intermediate_18_intermediate_14_sub,
--        intermediate_18.intermediate_14_obj AS intermediate_18_intermediate_14_obj,
--        intermediate_18.intermediate_1_obj AS intermediate_18_intermediate_1_obj,
--        intermediate_18.intermediate_1_sub AS intermediate_18_intermediate_1_sub,
...
--     FROM wgpb AS t3
--     LEFT JOIN sub_obj_2 c ON t3.obj = c.val
--     WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 97) AS intermediate_14
--      ON forceorder(intermediate_1.obj = intermediate_14.sub)) AS intermediate_18 JOIN 
...
--     FROM wgpb AS t4
--     LEFT JOIN sub_obj_2 c ON t4.sub = c.val
--     WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 97) AS intermediate_16
--      ON forceorder(intermediate_3.obj = intermediate_16.obj)) AS intermediate_19 ON forceorder(intermediate_18.intermediate_1_sub = intermediate_19.intermediate_3_sub AND intermediate_18.intermediate_14_obj = intermediate_19.intermediate_16_sub)) AS intermediate_20
--         ;
-- SELECT COUNT(*)
-- FROM 
-- (SELECT intermediate_21.intermediate_15_obj AS intermediate_21_intermediate_15_obj,
...
--        intermediate_21.intermediate_15_sub AS intermediate_21_intermediate_15_sub,
...
--         FROM sub_obj_2 s
--         WHERE s.cnt > 97) c
--         ON t3.obj = c.val) AS intermediate_15
--      ON forceorder(intermediate_1.obj = intermediate_15.sub)) AS intermediate_21 JOIN 
-- (SELECT intermediate_3.sub AS intermediate_3_sub,
--        intermediate_3.obj AS intermediate_3_obj,
...
--         FROM sub_obj_2 s
--         WHERE s.cnt > 97) c
--         ON t4.sub = c.val) AS intermediate_17
--      JOIN 
--     (SELECT t2.* 
--     FROM wgpb AS t2
--     JOIN (
...
--         WHERE s.cnt > 201) c
--         ON t2.sub = c.val) AS intermediate_3
--      ON forceorder(intermediate_3.obj = intermediate_17.obj)) AS intermediate_22 ON forceorder(intermediate_21.intermediate_1_sub = intermediate_22.intermediate_3_sub AND intermediate_21.intermediate_15_obj = intermediate_22.intermediate_17_sub)) AS intermediate_23
--         ;