...
\echo join time:
EXPLAIN ANALYZE EXPLAIN ANALYZE SELECT COUNT(*) FROM (SELECT sub, obj FROM uspatent WHERE sub % 3 = 1) AS t1, uspatent AS t2, uspatent AS t3, uspatent AS t4
