...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 270) AS intermediate_4
     JOIN 
    (SELECT t2.* 
    FROM topcats AS t2
    LEFT JOIN sub_obj_3 c ON t2.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 270) AS intermediate_6
...
FROM 
    ...
    LEFT JOIN sub_obj_1 c ON t3.sub = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 146) AS intermediate_0
     ON forceorder(intermediate_0.obj = intermediate_5.sub)) AS intermediate_12 JOIN 
(SELECT intermediate_2.obj AS intermediate_2_obj,
       intermediate_2.sub AS intermediate_2_sub,
...
FROM 
    ...
    LEFT JOIN sub_obj_1 c ON t1.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 146) AS intermediate_2
     ON forceorder(intermediate_2.sub = intermediate_7.sub)) AS intermediate_11 ON forceorder(intermediate_11.intermediate_2_obj = intermediate_12.intermediate_0_sub AND intermediate_11.intermediate_7_obj = intermediate_12.intermediate_5_obj)) AS intermediate_13
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
...
FROM 
    ...
    FROM topcats AS t4
    LEFT JOIN sub_obj_3 c ON t4.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 270) AS intermediate_14
     ON forceorder(intermediate_1.obj = intermediate_14.sub)) AS intermediate_19 JOIN 
...
FROM 
    ...
    FROM topcats AS t2
    LEFT JOIN sub_obj_3 c ON t2.obj = c.val
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 270) AS intermediate_16
     ON forceorder(intermediate_3.sub = intermediate_16.sub)) AS intermediate_18 ON forceorder(intermediate_18.intermediate_3_obj = intermediate_19.intermediate_1_sub AND intermediate_18.intermediate_16_obj = intermediate_19.intermediate_14_obj)) AS intermediate_20
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 146) c
        ON t3.sub = c.val) AS intermediate_1
     ON forceorder(intermediate_1.obj = intermediate_15.sub)) AS intermediate_22 JOIN 
(SELECT intermediate_3.obj AS intermediate_3_obj,
       intermediate_3.sub AS intermediate_3_sub,
...
FROM 
    ...
    JOIN (
     ...
     ON forceorder(intermediate_3.sub = intermediate_17.sub)) AS intermediate_21 ON forceorder(intermediate_21.intermediate_3_obj = intermediate_22.intermediate_1_sub AND intermediate_21.intermediate_17_obj = intermediate_22.intermediate_15_obj)) AS intermediate_23
        ;