...
FROM 
    ...
    JOIN (
     ...
     JOIN orkut AS t5 ON forceorder(intermediate_7.obj = t5.sub)) AS intermediate_14 JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN orkut AS t5 ON forceorder(intermediate_3.sub = t5.obj)) AS intermediate_22 JOIN 
