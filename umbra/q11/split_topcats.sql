...
JOIN (
    ...
    WHERE s.cnt > 323) c
    ON t.obj = c.val) AS intermediate_3
 JOIN topcats AS t5 ON forceorder(intermediate_3.sub = t5.obj)) AS intermediate_14 JOIN 
...
JOIN (
 ...
 JOIN topcats AS t5 ON forceorder(intermediate_19.obj = t5.sub)) AS intermediate_22 JOIN 
