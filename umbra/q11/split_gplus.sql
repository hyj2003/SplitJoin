...
JOIN (
 ...
 JOIN gplus AS t5 ON forceorder(intermediate_7.obj = t5.sub)) AS intermediate_9 ON forceorder(intermediate_3.sub = intermediate_9.t5_obj)) AS intermediate_10 ON forceorder(intermediate_8.intermediate_1_sub = intermediate_10.intermediate_3_obj AND intermediate_8.intermediate_5_obj = intermediate_10.intermediate_9_intermediate_7_sub)) AS intermediate_11
;
SELECT COUNT(*)
FROM 
...
JOIN (
    ...
    WHERE s.cnt > 862) c
    ON t.obj = c.val) AS intermediate_3
 JOIN gplus AS t5 ON forceorder(intermediate_3.sub = t5.obj)) AS intermediate_14 JOIN 
...
JOIN (
 ...
 JOIN gplus AS t5 ON forceorder(intermediate_19.obj = t5.sub)) AS intermediate_22 JOIN 
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_25.intermediate_16_obj AS intermediate_25_intermediate_16_obj,
       ...
       intermediate_25.intermediate_16_sub AS intermediate_25_intermediate_16_sub,
...
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 862) AS intermediate_18
 JOIN gplus AS t5 ON forceorder(intermediate_18.obj = t5.sub)) AS intermediate_26 JOIN 
...
LEFT JOIN sub_obj c ON t.sub = c.val
WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 862) AS intermediate_0
 ON forceorder(intermediate_0.sub = intermediate_2.obj)) AS intermediate_24 ON forceorder(intermediate_24.intermediate_0_obj = intermediate_16.sub)) AS intermediate_25 ON forceorder(intermediate_25.intermediate_16_obj = intermediate_26.intermediate_18_sub AND intermediate_25.intermediate_24_intermediate_2_sub = intermediate_26.t5_obj)) AS intermediate_27
;