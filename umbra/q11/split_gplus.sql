...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 862) AS intermediate_6
     JOIN gplus AS t5 ON forceorder(intermediate_6.obj = t5.sub)) AS intermediate_10 JOIN 
...
FROM 
    ...
    WHERE CASE WHEN c.cnt IS NULL THEN 0 ELSE c.cnt END <= 862) AS intermediate_0
     ON forceorder(intermediate_0.sub = intermediate_2.obj)) AS intermediate_8 ON forceorder(intermediate_8.intermediate_0_obj = intermediate_4.sub)) AS intermediate_9 ON forceorder(intermediate_9.intermediate_4_obj = intermediate_10.intermediate_6_sub AND intermediate_9.intermediate_8_intermediate_2_sub = intermediate_10.t5_obj)) AS intermediate_11
        ;EXPLAIN ANALYZE 
SELECT COUNT(*)
FROM 
...
FROM 
    ...
    JOIN (
     ...
     JOIN gplus AS t5 ON forceorder(intermediate_7.obj = t5.sub)) AS intermediate_14 JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN gplus AS t5 ON forceorder(intermediate_3.sub = t5.obj)) AS intermediate_22 JOIN 
