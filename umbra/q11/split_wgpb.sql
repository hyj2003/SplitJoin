...
SELECT COUNT(*)
FROM 
(SELECT intermediate_13.intermediate_12_intermediate_0_sub AS intermediate_13_intermediate_12_intermediate_0_sub,
...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t5 ON forceorder(intermediate_7.obj = t5.sub)) AS intermediate_14 JOIN 
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_21.intermediate_20_intermediate_1_sub AS intermediate_21_intermediate_20_intermediate_1_sub,
       ...
       intermediate_21.intermediate_20_intermediate_16_obj AS intermediate_21_intermediate_20_intermediate_16_obj,
...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t5 ON forceorder(intermediate_3.sub = t5.obj)) AS intermediate_22 JOIN 
...
(SELECT intermediate_24.intermediate_1_obj AS intermediate_24_intermediate_1_obj,
       ...
       intermediate_26.intermediate_3_obj AS intermediate_26_intermediate_3_obj,
       intermediate_26.intermediate_3_sub AS intermediate_26_intermediate_3_sub,
       intermediate_26.intermediate_25_t5_obj AS intermediate_26_intermediate_25_t5_obj,
       intermediate_26.intermediate_25_t5_sub AS intermediate_26_intermediate_25_t5_sub
FROM 
(SELECT intermediate_1.obj AS intermediate_1_obj,
       intermediate_1.sub AS intermediate_1_sub,
...
FROM 
    ...
    JOIN (
        ...
        WHERE s.cnt > 160) c
        ON t.sub = c.val) AS intermediate_1
     ON forceorder(intermediate_1.obj = intermediate_17.sub)) AS intermediate_24 JOIN 
(SELECT intermediate_3.obj AS intermediate_3_obj,
       intermediate_3.sub AS intermediate_3_sub,
       ...
       intermediate_25.t5_sub AS intermediate_25_t5_sub,
       intermediate_25.t5_obj AS intermediate_25_t5_obj
FROM 
    (SELECT t.* 
    FROM wgpb t
    JOIN (
...
FROM 
    ...
    JOIN (
     ...
     JOIN wgpb AS t5 ON forceorder(intermediate_19.obj = t5.sub)) AS intermediate_25 ON forceorder(intermediate_3.sub = intermediate_25.t5_obj)) AS intermediate_26 ON forceorder(intermediate_24.intermediate_1_sub = intermediate_26.intermediate_3_obj AND intermediate_24.intermediate_17_obj = intermediate_26.intermediate_25_intermediate_19_sub)) AS intermediate_27
        ;