...
SELECT COUNT(*)
FROM 
(SELECT intermediate_9.t3_sub AS intermediate_9_t3_sub,
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_14.intermediate_2_sub AS intermediate_14_intermediate_2_sub,
...
FROM 
    ...
    JOIN (
     ...
     JOIN gplus AS t6 ON forceorder(intermediate_7.obj = t6.sub)) AS intermediate_15 ON forceorder(intermediate_0.sub = intermediate_15.t6_obj)) AS intermediate_16 JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN gplus AS t6 ON forceorder(intermediate_1.sub = t6.obj)) AS intermediate_24 ON forceorder(intermediate_20.obj = intermediate_24.t6_sub)) AS intermediate_25 JOIN 
(SELECT intermediate_22.t3_obj AS intermediate_22_t3_obj,
...
SELECT COUNT(*)
FROM 
(SELECT intermediate_28.intermediate_27_t3_sub AS intermediate_28_intermediate_27_t3_sub,
       intermediate_28.intermediate_27_t3_obj AS intermediate_28_intermediate_27_t3_obj,
...
FROM 
    ...
    JOIN (
     ...
     JOIN gplus AS t6 ON forceorder(intermediate_21.obj = t6.sub)) AS intermediate_29 ON forceorder(intermediate_1.sub = intermediate_29.t6_obj)) AS intermediate_30 JOIN 
(SELECT intermediate_3.sub AS intermediate_3_sub,
       intermediate_3.obj AS intermediate_3_obj,
