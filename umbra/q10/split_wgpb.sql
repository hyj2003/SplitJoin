...
JOIN (
 ...
 JOIN wgpb AS t6 ON forceorder(intermediate_7.obj = t6.sub)) AS intermediate_10 ON forceorder(intermediate_1.sub = intermediate_10.t6_obj)) AS intermediate_11 JOIN 
...
JOIN (
    ...
    WHERE s.cnt > 180) c
    ON t.obj = c.val) AS intermediate_1
 JOIN wgpb AS t6 ON forceorder(intermediate_1.sub = t6.obj)) AS intermediate_15 ON forceorder(intermediate_6.obj = intermediate_15.t6_sub)) AS intermediate_16 JOIN 
...
JOIN (
 ...
 JOIN wgpb AS t6 ON forceorder(intermediate_21.obj = t6.sub)) AS intermediate_24 ON forceorder(intermediate_0.sub = intermediate_24.t6_obj)) AS intermediate_25 JOIN 
