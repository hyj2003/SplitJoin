...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t6 ON forceorder(intermediate_7.obj = t6.sub)) AS intermediate_15 ON forceorder(intermediate_0.sub = intermediate_15.t6_obj)) AS intermediate_16 JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t6 ON forceorder(intermediate_1.sub = t6.obj)) AS intermediate_24 ON forceorder(intermediate_20.obj = intermediate_24.t6_sub)) AS intermediate_25 JOIN 
...
FROM 
    ...
    JOIN (
     ...
     JOIN topcats AS t6 ON forceorder(intermediate_21.obj = t6.sub)) AS intermediate_29 ON forceorder(intermediate_1.sub = intermediate_29.t6_obj)) AS intermediate_30 JOIN 
(SELECT intermediate_3.sub AS intermediate_3_sub,
       intermediate_3.obj AS intermediate_3_obj,
