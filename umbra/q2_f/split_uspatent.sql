...
\echo join time:
SELECT COUNT(*) FROM (SELECT sub, obj FROM uspatent WHERE sub % 3 = 1) AS t1, uspatent AS t2, uspatent AS t3, uspatent AS t4
WHERE t1.obj = t2.sub AND t2.obj = t3.obj AND t3.sub = t4.obj AND t4.sub = t1.sub;;